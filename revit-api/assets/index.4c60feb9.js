var Et=Object.defineProperty;var Le=Object.getOwnPropertySymbols;var jt=Object.prototype.hasOwnProperty,Pt=Object.prototype.propertyIsEnumerable;var Oe=(s,e,t)=>e in s?Et(s,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):s[e]=t,pe=(s,e)=>{for(var t in e||(e={}))jt.call(e,t)&&Oe(s,t,e[t]);if(Le)for(var t of Le(e))Pt.call(e,t)&&Oe(s,t,e[t]);return s};const Gt=function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))r(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&r(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerpolicy&&(i.referrerPolicy=n.referrerpolicy),n.crossorigin==="use-credentials"?i.credentials="include":n.crossorigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function r(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}};Gt();function B(){}const Bt=s=>s;function ee(s,e){for(const t in e)s[t]=e[t];return s}function wt(s){return s()}function Ue(){return Object.create(null)}function ne(s){s.forEach(wt)}function bt(s){return typeof s=="function"}function E(s,e){return s!=s?e==e:s!==e||s&&typeof s=="object"||typeof s=="function"}let we;function je(s,e){return we||(we=document.createElement("a")),we.href=e,s===we.href}function Mt(s){return Object.keys(s).length===0}function M(s,e,t,r){if(s){const n=kt(s,e,t,r);return s[0](n)}}function kt(s,e,t,r){return s[1]&&r?ee(t.ctx.slice(),s[1](r(e))):t.ctx}function N(s,e,t,r){if(s[2]&&r){const n=s[2](r(t));if(e.dirty===void 0)return n;if(typeof n=="object"){const i=[],l=Math.max(e.dirty.length,n.length);for(let a=0;a<l;a+=1)i[a]=e.dirty[a]|n[a];return i}return e.dirty|n}return e.dirty}function L(s,e,t,r,n,i){if(n){const l=kt(e,t,r,i);s.p(l,n)}}function O(s){if(s.ctx.length>32){const e=[],t=s.ctx.length/32;for(let r=0;r<t;r++)e[r]=-1;return e}return-1}function Nt(s){const e={};for(const t in s)t[0]!=="$"&&(e[t]=s[t]);return e}function qe(s,e){const t={};e=new Set(e);for(const r in s)!e.has(r)&&r[0]!=="$"&&(t[r]=s[r]);return t}const yt=typeof window!="undefined";let Lt=yt?()=>window.performance.now():()=>Date.now(),Ge=yt?s=>requestAnimationFrame(s):B;const oe=new Set;function At(s){oe.forEach(e=>{e.c(s)||(oe.delete(e),e.f())}),oe.size!==0&&Ge(At)}function Ot(s){let e;return oe.size===0&&Ge(At),{promise:new Promise(t=>{oe.add(e={c:s,f:t})}),abort(){oe.delete(e)}}}function H(s,e){s.appendChild(e)}function $t(s){if(!s)return document;const e=s.getRootNode?s.getRootNode():s.ownerDocument;return e&&e.host?e:s.ownerDocument}function Ut(s){const e=x("style");return qt($t(s),e),e.sheet}function qt(s,e){H(s.head||s,e)}function w(s,e,t){s.insertBefore(e,t||null)}function _(s){s.parentNode.removeChild(s)}function se(s,e){for(let t=0;t<s.length;t+=1)s[t]&&s[t].d(e)}function x(s){return document.createElement(s)}function Ht(s){return document.createElementNS("http://www.w3.org/2000/svg",s)}function V(s){return document.createTextNode(s)}function F(){return V(" ")}function j(){return V("")}function ze(s,e,t,r){return s.addEventListener(e,t,r),()=>s.removeEventListener(e,t,r)}function z(s,e,t){t==null?s.removeAttribute(e):s.getAttribute(e)!==t&&s.setAttribute(e,t)}function Ft(s){return Array.from(s.childNodes)}function ie(s,e){e=""+e,s.wholeText!==e&&(s.data=e)}function He(s,e,t,r){t===null?s.style.removeProperty(e):s.style.setProperty(e,t,r?"important":"")}function zt(s,e,{bubbles:t=!1,cancelable:r=!1}={}){const n=document.createEvent("CustomEvent");return n.initCustomEvent(s,t,r,e),n}class Wt{constructor(e=!1){this.is_svg=!1,this.is_svg=e,this.e=this.n=null}c(e){this.h(e)}m(e,t,r=null){this.e||(this.is_svg?this.e=Ht(t.nodeName):this.e=x(t.nodeName),this.t=t,this.c(e)),this.i(r)}h(e){this.e.innerHTML=e,this.n=Array.from(this.e.childNodes)}i(e){for(let t=0;t<this.n.length;t+=1)w(this.t,this.n[t],e)}p(e){this.d(),this.h(e),this.i(this.a)}d(){this.n.forEach(_)}}const xe=new Map;let ve=0;function Zt(s){let e=5381,t=s.length;for(;t--;)e=(e<<5)-e^s.charCodeAt(t);return e>>>0}function Vt(s,e){const t={stylesheet:Ut(e),rules:{}};return xe.set(s,t),t}function Fe(s,e,t,r,n,i,l,a=0){const o=16.666/r;let c=`{
`;for(let A=0;A<=1;A+=o){const I=e+(t-e)*i(A);c+=A*100+`%{${l(I,1-I)}}
`}const f=c+`100% {${l(t,1-t)}}
}`,g=`__svelte_${Zt(f)}_${a}`,m=$t(s),{stylesheet:d,rules:u}=xe.get(m)||Vt(m,s);u[g]||(u[g]=!0,d.insertRule(`@keyframes ${g} ${f}`,d.cssRules.length));const k=s.style.animation||"";return s.style.animation=`${k?`${k}, `:""}${g} ${r}ms linear ${n}ms 1 both`,ve+=1,g}function Qt(s,e){const t=(s.style.animation||"").split(", "),r=t.filter(e?i=>i.indexOf(e)<0:i=>i.indexOf("__svelte")===-1),n=t.length-r.length;n&&(s.style.animation=r.join(", "),ve-=n,ve||Kt())}function Kt(){Ge(()=>{ve||(xe.forEach(s=>{const{stylesheet:e}=s;let t=e.cssRules.length;for(;t--;)e.deleteRule(t);s.rules={}}),xe.clear())})}let ge;function me(s){ge=s}function Te(){if(!ge)throw new Error("Function called outside component initialization");return ge}function xt(s){Te().$$.on_mount.push(s)}function Xt(){const s=Te();return(e,t,{cancelable:r=!1}={})=>{const n=s.$$.callbacks[e];if(n){const i=zt(e,t,{cancelable:r});return n.slice().forEach(l=>{l.call(s,i)}),!i.defaultPrevented}return!0}}function Jt(s,e){return Te().$$.context.set(s,e),e}function Yt(s){return Te().$$.context.get(s)}const he=[],We=[],ye=[],Ze=[],en=Promise.resolve();let Pe=!1;function tn(){Pe||(Pe=!0,en.then(vt))}function Q(s){ye.push(s)}const Re=new Set;let be=0;function vt(){const s=ge;do{for(;be<he.length;){const e=he[be];be++,me(e),nn(e.$$)}for(me(null),he.length=0,be=0;We.length;)We.pop()();for(let e=0;e<ye.length;e+=1){const t=ye[e];Re.has(t)||(Re.add(t),t())}ye.length=0}while(he.length);for(;Ze.length;)Ze.pop()();Pe=!1,Re.clear(),me(s)}function nn(s){if(s.fragment!==null){s.update(),ne(s.before_update);const e=s.dirty;s.dirty=[-1],s.fragment&&s.fragment.p(s.ctx,e),s.after_update.forEach(Q)}}let de;function rn(){return de||(de=Promise.resolve(),de.then(()=>{de=null})),de}function Se(s,e,t){s.dispatchEvent(zt(`${e?"intro":"outro"}${t}`))}const Ae=new Set;let Y;function T(){Y={r:0,c:[],p:Y}}function R(){Y.r||ne(Y.c),Y=Y.p}function p(s,e){s&&s.i&&(Ae.delete(s),s.i(e))}function h(s,e,t,r){if(s&&s.o){if(Ae.has(s))return;Ae.add(s),Y.c.push(()=>{Ae.delete(s),r&&(t&&s.d(1),r())}),s.o(e)}}const sn={duration:0};function Ce(s,e,t,r){let n=e(s,t),i=r?0:1,l=null,a=null,o=null;function c(){o&&Qt(s,o)}function f(m,d){const u=m.b-i;return d*=Math.abs(u),{a:i,b:m.b,d:u,duration:d,start:m.start,end:m.start+d,group:m.group}}function g(m){const{delay:d=0,duration:u=300,easing:k=Bt,tick:A=B,css:I}=n||sn,U={start:Lt()+d,b:m};m||(U.group=Y,Y.r+=1),l||a?a=U:(I&&(c(),o=Fe(s,i,m,u,d,k,I)),m&&A(0,1),l=f(U,u),Q(()=>Se(s,m,"start")),Ot(Z=>{if(a&&Z>a.start&&(l=f(a,u),a=null,Se(s,l.b,"start"),I&&(c(),o=Fe(s,i,l.b,l.duration,0,k,n.css))),l){if(Z>=l.end)A(i=l.b,1-i),Se(s,l.b,"end"),a||(l.b?c():--l.group.r||ne(l.group.c)),l=null;else if(Z>=l.start){const X=Z-l.start;i=l.a+l.d*k(X/l.duration),A(i,1-i)}}return!!(l||a)}))}return{run(m){bt(n)?rn().then(()=>{n=n(),g(m)}):g(m)},end(){c(),l=a=null}}}function ae(s,e){const t={},r={},n={$$scope:1};let i=s.length;for(;i--;){const l=s[i],a=e[i];if(a){for(const o in l)o in a||(r[o]=1);for(const o in a)n[o]||(t[o]=a[o],n[o]=1);s[i]=a}else for(const o in l)n[o]=1}for(const l in r)l in t||(t[l]=void 0);return t}function ce(s){return typeof s=="object"&&s!==null?s:{}}function D(s){s&&s.c()}function v(s,e,t,r){const{fragment:n,on_mount:i,on_destroy:l,after_update:a}=s.$$;n&&n.m(e,t),r||Q(()=>{const o=i.map(wt).filter(bt);l?l.push(...o):ne(o),s.$$.on_mount=[]}),a.forEach(Q)}function C(s,e){const t=s.$$;t.fragment!==null&&(ne(t.on_destroy),t.fragment&&t.fragment.d(e),t.on_destroy=t.fragment=null,t.ctx=[])}function ln(s,e){s.$$.dirty[0]===-1&&(he.push(s),tn(),s.$$.dirty.fill(0)),s.$$.dirty[e/31|0]|=1<<e%31}function P(s,e,t,r,n,i,l,a=[-1]){const o=ge;me(s);const c=s.$$={fragment:null,ctx:null,props:i,update:B,not_equal:n,bound:Ue(),on_mount:[],on_destroy:[],on_disconnect:[],before_update:[],after_update:[],context:new Map(e.context||(o?o.$$.context:[])),callbacks:Ue(),dirty:a,skip_bound:!1,root:e.target||o.$$.root};l&&l(c.root);let f=!1;if(c.ctx=t?t(s,e.props||{},(g,m,...d)=>{const u=d.length?d[0]:m;return c.ctx&&n(c.ctx[g],c.ctx[g]=u)&&(!c.skip_bound&&c.bound[g]&&c.bound[g](u),f&&ln(s,g)),m}):[],c.update(),f=!0,ne(c.before_update),c.fragment=r?r(c.ctx):!1,e.target){if(e.hydrate){const g=Ft(e.target);c.fragment&&c.fragment.l(g),g.forEach(_)}else c.fragment&&c.fragment.c();e.intro&&p(s.$$.fragment),v(s,e.target,e.anchor,e.customElement),vt()}me(o)}class G{$destroy(){C(this,1),this.$destroy=B}$on(e,t){const r=this.$$.callbacks[e]||(this.$$.callbacks[e]=[]);return r.push(t),()=>{const n=r.indexOf(t);n!==-1&&r.splice(n,1)}}$set(e){this.$$set&&!Mt(e)&&(this.$$.skip_bound=!0,this.$$set(e),this.$$.skip_bound=!1)}}function on(){const s=console.warn;console.warn=e=>{e.includes("unknown prop")||e.includes("unexpected slot")||s(e)},xt(()=>{console.warn=s})}function Ve(s,e,t){const r=s.slice();return r[18]=e[t],r}function Qe(s,e,t){const r=s.slice();return r[18]=e[t],r}function Ke(s,e,t){const r=s.slice();return r[10]=e[t],r}function Xe(s,e,t){const r=s.slice();return r[13]=e[t],r[15]=t,r}function Je(s,e,t){const r=s.slice();return r[16]=e[t],r[15]=t,r}function Ye(s,e,t){const r=s.slice();return r[7]=e[t],r}function an(s){let e,t,r,n;const i=[pn,un,fn],l=[];function a(o,c){return o[0]==="table"?0:o[0]==="list"?1:2}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,c){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function cn(s){let e,t,r=s[1],n=[];for(let l=0;l<r.length;l+=1)n[l]=st(Ye(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=j()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&34){r=l[1];let o;for(o=0;o<r.length;o+=1){const c=Ye(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=st(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function fn(s){let e,t,r;const n=[s[6]];var i=s[5][s[0]];function l(a){let o={$$slots:{default:[mn]},$$scope:{ctx:a}};for(let c=0;c<n.length;c+=1)o=ee(o,n[c]);return{props:o}}return i&&(e=new i(l(s))),{c(){e&&D(e.$$.fragment),t=j()},m(a,o){e&&v(e,a,o),w(a,t,o),r=!0},p(a,o){const c=o&64?ae(n,[ce(a[6])]):{};if(o&8388706&&(c.$$scope={dirty:o,ctx:a}),i!==(i=a[5][a[0]])){if(e){T();const f=e;h(f.$$.fragment,1,0,()=>{C(f,1)}),R()}i?(e=new i(l(a)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else i&&e.$set(c)},i(a){r||(e&&p(e.$$.fragment,a),r=!0)},o(a){e&&h(e.$$.fragment,a),r=!1},d(a){a&&_(t),e&&C(e,a)}}}function un(s){let e,t,r,n;const i=[_n,gn],l=[];function a(o,c){return o[4]?0:1}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,c){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function pn(s){let e,t,r;var n=s[5].table;function i(l){return{props:{$$slots:{default:[Dn]},$$scope:{ctx:l}}}}return n&&(e=new n(i(s))),{c(){e&&D(e.$$.fragment),t=j()},m(l,a){e&&v(e,l,a),w(l,t,a),r=!0},p(l,a){const o={};if(a&8388716&&(o.$$scope={dirty:a,ctx:l}),n!==(n=l[5].table)){if(e){T();const c=e;h(c.$$.fragment,1,0,()=>{C(c,1)}),R()}n?(e=new n(i(l)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else n&&e.$set(o)},i(l){r||(e&&p(e.$$.fragment,l),r=!0)},o(l){e&&h(e.$$.fragment,l),r=!1},d(l){l&&_(t),e&&C(e,l)}}}function dn(s){let e=s[6].raw+"",t;return{c(){t=V(e)},m(r,n){w(r,t,n)},p(r,n){n&64&&e!==(e=r[6].raw+"")&&ie(t,e)},i:B,o:B,d(r){r&&_(t)}}}function hn(s){let e,t;return e=new le({props:{tokens:s[1],renderers:s[5]}}),{c(){D(e.$$.fragment)},m(r,n){v(e,r,n),t=!0},p(r,n){const i={};n&2&&(i.tokens=r[1]),n&32&&(i.renderers=r[5]),e.$set(i)},i(r){t||(p(e.$$.fragment,r),t=!0)},o(r){h(e.$$.fragment,r),t=!1},d(r){C(e,r)}}}function mn(s){let e,t,r,n;const i=[hn,dn],l=[];function a(o,c){return o[1]?0:1}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,c){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function gn(s){let e,t,r;const n=[{ordered:s[4]},s[6]];var i=s[5].list;function l(a){let o={$$slots:{default:[bn]},$$scope:{ctx:a}};for(let c=0;c<n.length;c+=1)o=ee(o,n[c]);return{props:o}}return i&&(e=new i(l(s))),{c(){e&&D(e.$$.fragment),t=j()},m(a,o){e&&v(e,a,o),w(a,t,o),r=!0},p(a,o){const c=o&80?ae(n,[o&16&&{ordered:a[4]},o&64&&ce(a[6])]):{};if(o&8388704&&(c.$$scope={dirty:o,ctx:a}),i!==(i=a[5].list)){if(e){T();const f=e;h(f.$$.fragment,1,0,()=>{C(f,1)}),R()}i?(e=new i(l(a)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else i&&e.$set(c)},i(a){r||(e&&p(e.$$.fragment,a),r=!0)},o(a){e&&h(e.$$.fragment,a),r=!1},d(a){a&&_(t),e&&C(e,a)}}}function _n(s){let e,t,r;const n=[{ordered:s[4]},s[6]];var i=s[5].list;function l(a){let o={$$slots:{default:[yn]},$$scope:{ctx:a}};for(let c=0;c<n.length;c+=1)o=ee(o,n[c]);return{props:o}}return i&&(e=new i(l(s))),{c(){e&&D(e.$$.fragment),t=j()},m(a,o){e&&v(e,a,o),w(a,t,o),r=!0},p(a,o){const c=o&80?ae(n,[o&16&&{ordered:a[4]},o&64&&ce(a[6])]):{};if(o&8388704&&(c.$$scope={dirty:o,ctx:a}),i!==(i=a[5].list)){if(e){T();const f=e;h(f.$$.fragment,1,0,()=>{C(f,1)}),R()}i?(e=new i(l(a)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else i&&e.$set(c)},i(a){r||(e&&p(e.$$.fragment,a),r=!0)},o(a){e&&h(e.$$.fragment,a),r=!1},d(a){a&&_(t),e&&C(e,a)}}}function wn(s){let e,t,r;return e=new le({props:{tokens:s[18].tokens,renderers:s[5]}}),{c(){D(e.$$.fragment),t=F()},m(n,i){v(e,n,i),w(n,t,i),r=!0},p(n,i){const l={};i&64&&(l.tokens=n[18].tokens),i&32&&(l.renderers=n[5]),e.$set(l)},i(n){r||(p(e.$$.fragment,n),r=!0)},o(n){h(e.$$.fragment,n),r=!1},d(n){C(e,n),n&&_(t)}}}function et(s){let e,t,r;const n=[s[18]];var i=s[5].unorderedlistitem||s[5].listitem;function l(a){let o={$$slots:{default:[wn]},$$scope:{ctx:a}};for(let c=0;c<n.length;c+=1)o=ee(o,n[c]);return{props:o}}return i&&(e=new i(l(s))),{c(){e&&D(e.$$.fragment),t=j()},m(a,o){e&&v(e,a,o),w(a,t,o),r=!0},p(a,o){const c=o&64?ae(n,[ce(a[18])]):{};if(o&8388704&&(c.$$scope={dirty:o,ctx:a}),i!==(i=a[5].unorderedlistitem||a[5].listitem)){if(e){T();const f=e;h(f.$$.fragment,1,0,()=>{C(f,1)}),R()}i?(e=new i(l(a)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else i&&e.$set(c)},i(a){r||(e&&p(e.$$.fragment,a),r=!0)},o(a){e&&h(e.$$.fragment,a),r=!1},d(a){a&&_(t),e&&C(e,a)}}}function bn(s){let e,t,r=s[6].items,n=[];for(let l=0;l<r.length;l+=1)n[l]=et(Ve(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=j()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&96){r=l[6].items;let o;for(o=0;o<r.length;o+=1){const c=Ve(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=et(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function kn(s){let e,t,r;return e=new le({props:{tokens:s[18].tokens,renderers:s[5]}}),{c(){D(e.$$.fragment),t=F()},m(n,i){v(e,n,i),w(n,t,i),r=!0},p(n,i){const l={};i&64&&(l.tokens=n[18].tokens),i&32&&(l.renderers=n[5]),e.$set(l)},i(n){r||(p(e.$$.fragment,n),r=!0)},o(n){h(e.$$.fragment,n),r=!1},d(n){C(e,n),n&&_(t)}}}function tt(s){let e,t,r;const n=[s[18]];var i=s[5].orderedlistitem||s[5].listitem;function l(a){let o={$$slots:{default:[kn]},$$scope:{ctx:a}};for(let c=0;c<n.length;c+=1)o=ee(o,n[c]);return{props:o}}return i&&(e=new i(l(s))),{c(){e&&D(e.$$.fragment),t=j()},m(a,o){e&&v(e,a,o),w(a,t,o),r=!0},p(a,o){const c=o&64?ae(n,[ce(a[18])]):{};if(o&8388704&&(c.$$scope={dirty:o,ctx:a}),i!==(i=a[5].orderedlistitem||a[5].listitem)){if(e){T();const f=e;h(f.$$.fragment,1,0,()=>{C(f,1)}),R()}i?(e=new i(l(a)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else i&&e.$set(c)},i(a){r||(e&&p(e.$$.fragment,a),r=!0)},o(a){e&&h(e.$$.fragment,a),r=!1},d(a){a&&_(t),e&&C(e,a)}}}function yn(s){let e,t,r=s[6].items,n=[];for(let l=0;l<r.length;l+=1)n[l]=tt(Qe(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=j()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&96){r=l[6].items;let o;for(o=0;o<r.length;o+=1){const c=Qe(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=tt(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function An(s){let e,t,r;return e=new le({props:{tokens:s[16].tokens,renderers:s[5]}}),{c(){D(e.$$.fragment),t=F()},m(n,i){v(e,n,i),w(n,t,i),r=!0},p(n,i){const l={};i&4&&(l.tokens=n[16].tokens),i&32&&(l.renderers=n[5]),e.$set(l)},i(n){r||(p(e.$$.fragment,n),r=!0)},o(n){h(e.$$.fragment,n),r=!1},d(n){C(e,n),n&&_(t)}}}function nt(s){let e,t,r;var n=s[5].tablecell;function i(l){return{props:{header:!0,align:l[6].align[l[15]]||"center",$$slots:{default:[An]},$$scope:{ctx:l}}}}return n&&(e=new n(i(s))),{c(){e&&D(e.$$.fragment),t=j()},m(l,a){e&&v(e,l,a),w(l,t,a),r=!0},p(l,a){const o={};if(a&64&&(o.align=l[6].align[l[15]]||"center"),a&8388644&&(o.$$scope={dirty:a,ctx:l}),n!==(n=l[5].tablecell)){if(e){T();const c=e;h(c.$$.fragment,1,0,()=>{C(c,1)}),R()}n?(e=new n(i(l)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else n&&e.$set(o)},i(l){r||(e&&p(e.$$.fragment,l),r=!0)},o(l){e&&h(e.$$.fragment,l),r=!1},d(l){l&&_(t),e&&C(e,l)}}}function $n(s){let e,t,r=s[2],n=[];for(let l=0;l<r.length;l+=1)n[l]=nt(Je(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=j()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&100){r=l[2];let o;for(o=0;o<r.length;o+=1){const c=Je(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=nt(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function zn(s){let e,t,r;var n=s[5].tablerow;function i(l){return{props:{$$slots:{default:[$n]},$$scope:{ctx:l}}}}return n&&(e=new n(i(s))),{c(){e&&D(e.$$.fragment),t=j()},m(l,a){e&&v(e,l,a),w(l,t,a),r=!0},p(l,a){const o={};if(a&8388708&&(o.$$scope={dirty:a,ctx:l}),n!==(n=l[5].tablerow)){if(e){T();const c=e;h(c.$$.fragment,1,0,()=>{C(c,1)}),R()}n?(e=new n(i(l)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else n&&e.$set(o)},i(l){r||(e&&p(e.$$.fragment,l),r=!0)},o(l){e&&h(e.$$.fragment,l),r=!1},d(l){l&&_(t),e&&C(e,l)}}}function xn(s){let e,t;return e=new le({props:{tokens:s[13].tokens,renderers:s[5]}}),{c(){D(e.$$.fragment)},m(r,n){v(e,r,n),t=!0},p(r,n){const i={};n&8&&(i.tokens=r[13].tokens),n&32&&(i.renderers=r[5]),e.$set(i)},i(r){t||(p(e.$$.fragment,r),t=!0)},o(r){h(e.$$.fragment,r),t=!1},d(r){C(e,r)}}}function rt(s){let e,t,r;var n=s[5].tablecell;function i(l){return{props:{header:!1,align:l[6].align[l[15]]||"center",$$slots:{default:[xn]},$$scope:{ctx:l}}}}return n&&(e=new n(i(s))),{c(){e&&D(e.$$.fragment),t=j()},m(l,a){e&&v(e,l,a),w(l,t,a),r=!0},p(l,a){const o={};if(a&64&&(o.align=l[6].align[l[15]]||"center"),a&8388648&&(o.$$scope={dirty:a,ctx:l}),n!==(n=l[5].tablecell)){if(e){T();const c=e;h(c.$$.fragment,1,0,()=>{C(c,1)}),R()}n?(e=new n(i(l)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else n&&e.$set(o)},i(l){r||(e&&p(e.$$.fragment,l),r=!0)},o(l){e&&h(e.$$.fragment,l),r=!1},d(l){l&&_(t),e&&C(e,l)}}}function vn(s){let e,t,r=s[10],n=[];for(let l=0;l<r.length;l+=1)n[l]=rt(Xe(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=F()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&104){r=l[10];let o;for(o=0;o<r.length;o+=1){const c=Xe(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=rt(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function it(s){let e,t,r;var n=s[5].tablerow;function i(l){return{props:{$$slots:{default:[vn]},$$scope:{ctx:l}}}}return n&&(e=new n(i(s))),{c(){e&&D(e.$$.fragment),t=j()},m(l,a){e&&v(e,l,a),w(l,t,a),r=!0},p(l,a){const o={};if(a&8388712&&(o.$$scope={dirty:a,ctx:l}),n!==(n=l[5].tablerow)){if(e){T();const c=e;h(c.$$.fragment,1,0,()=>{C(c,1)}),R()}n?(e=new n(i(l)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else n&&e.$set(o)},i(l){r||(e&&p(e.$$.fragment,l),r=!0)},o(l){e&&h(e.$$.fragment,l),r=!1},d(l){l&&_(t),e&&C(e,l)}}}function Cn(s){let e,t,r=s[3],n=[];for(let l=0;l<r.length;l+=1)n[l]=it(Ke(s,r,l));const i=l=>h(n[l],1,1,()=>{n[l]=null});return{c(){for(let l=0;l<n.length;l+=1)n[l].c();e=j()},m(l,a){for(let o=0;o<n.length;o+=1)n[o].m(l,a);w(l,e,a),t=!0},p(l,a){if(a&104){r=l[3];let o;for(o=0;o<r.length;o+=1){const c=Ke(l,r,o);n[o]?(n[o].p(c,a),p(n[o],1)):(n[o]=it(c),n[o].c(),p(n[o],1),n[o].m(e.parentNode,e))}for(T(),o=r.length;o<n.length;o+=1)i(o);R()}},i(l){if(!t){for(let a=0;a<r.length;a+=1)p(n[a]);t=!0}},o(l){n=n.filter(Boolean);for(let a=0;a<n.length;a+=1)h(n[a]);t=!1},d(l){se(n,l),l&&_(e)}}}function Dn(s){let e,t,r,n,i;var l=s[5].tablehead;function a(f){return{props:{$$slots:{default:[zn]},$$scope:{ctx:f}}}}l&&(e=new l(a(s)));var o=s[5].tablebody;function c(f){return{props:{$$slots:{default:[Cn]},$$scope:{ctx:f}}}}return o&&(r=new o(c(s))),{c(){e&&D(e.$$.fragment),t=F(),r&&D(r.$$.fragment),n=j()},m(f,g){e&&v(e,f,g),w(f,t,g),r&&v(r,f,g),w(f,n,g),i=!0},p(f,g){const m={};if(g&8388708&&(m.$$scope={dirty:g,ctx:f}),l!==(l=f[5].tablehead)){if(e){T();const u=e;h(u.$$.fragment,1,0,()=>{C(u,1)}),R()}l?(e=new l(a(f)),D(e.$$.fragment),p(e.$$.fragment,1),v(e,t.parentNode,t)):e=null}else l&&e.$set(m);const d={};if(g&8388712&&(d.$$scope={dirty:g,ctx:f}),o!==(o=f[5].tablebody)){if(r){T();const u=r;h(u.$$.fragment,1,0,()=>{C(u,1)}),R()}o?(r=new o(c(f)),D(r.$$.fragment),p(r.$$.fragment,1),v(r,n.parentNode,n)):r=null}else o&&r.$set(d)},i(f){i||(e&&p(e.$$.fragment,f),r&&p(r.$$.fragment,f),i=!0)},o(f){e&&h(e.$$.fragment,f),r&&h(r.$$.fragment,f),i=!1},d(f){e&&C(e,f),f&&_(t),f&&_(n),r&&C(r,f)}}}function st(s){let e,t;const r=[s[7],{renderers:s[5]}];let n={};for(let i=0;i<r.length;i+=1)n=ee(n,r[i]);return e=new le({props:n}),{c(){D(e.$$.fragment)},m(i,l){v(e,i,l),t=!0},p(i,l){const a=l&34?ae(r,[l&2&&ce(i[7]),l&32&&{renderers:i[5]}]):{};e.$set(a)},i(i){t||(p(e.$$.fragment,i),t=!0)},o(i){h(e.$$.fragment,i),t=!1},d(i){C(e,i)}}}function In(s){let e,t,r,n;const i=[cn,an],l=[];function a(o,c){return o[0]?o[5][o[0]]?1:-1:0}return~(e=a(s))&&(t=l[e]=i[e](s)),{c(){t&&t.c(),r=j()},m(o,c){~e&&l[e].m(o,c),w(o,r,c),n=!0},p(o,[c]){let f=e;e=a(o),e===f?~e&&l[e].p(o,c):(t&&(T(),h(l[f],1,1,()=>{l[f]=null}),R()),~e?(t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r)):t=null)},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){~e&&l[e].d(o),o&&_(r)}}}function Tn(s,e,t){const r=["type","tokens","header","rows","ordered","renderers"];let n=qe(e,r),{type:i=void 0}=e,{tokens:l=void 0}=e,{header:a=void 0}=e,{rows:o=void 0}=e,{ordered:c=!1}=e,{renderers:f}=e;return on(),s.$$set=g=>{e=ee(ee({},e),Nt(g)),t(6,n=qe(e,r)),"type"in g&&t(0,i=g.type),"tokens"in g&&t(1,l=g.tokens),"header"in g&&t(2,a=g.header),"rows"in g&&t(3,o=g.rows),"ordered"in g&&t(4,c=g.ordered),"renderers"in g&&t(5,f=g.renderers)},[i,l,a,o,c,f,n]}class le extends G{constructor(e){super(),P(this,e,Tn,In,E,{type:0,tokens:1,header:2,rows:3,ordered:4,renderers:5})}}function Ct(){return{baseUrl:null,breaks:!1,extensions:null,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,tokenizer:null,walkTokens:null,xhtml:!1}}let fe=Ct();function Rn(s){fe=s}const Sn=/[&<>"']/,En=/[&<>"']/g,jn=/[<>"']|&(?!#?\w+;)/,Pn=/[<>"']|&(?!#?\w+;)/g,Gn={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},lt=s=>Gn[s];function q(s,e){if(e){if(Sn.test(s))return s.replace(En,lt)}else if(jn.test(s))return s.replace(Pn,lt);return s}const Bn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function Dt(s){return s.replace(Bn,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Mn=/(^|[^\[])\^/g;function S(s,e){s=typeof s=="string"?s:s.source,e=e||"";const t={replace:(r,n)=>(n=n.source||n,n=n.replace(Mn,"$1"),s=s.replace(r,n),t),getRegex:()=>new RegExp(s,e)};return t}const Nn=/[^\w:]/g,Ln=/^$|^[a-z][a-z0-9+.-]*:|^[?#]/i;function ot(s,e,t){if(s){let r;try{r=decodeURIComponent(Dt(t)).replace(Nn,"").toLowerCase()}catch{return null}if(r.indexOf("javascript:")===0||r.indexOf("vbscript:")===0||r.indexOf("data:")===0)return null}e&&!Ln.test(t)&&(t=Hn(e,t));try{t=encodeURI(t).replace(/%25/g,"%")}catch{return null}return t}const ke={},On=/^[^:]+:\/*[^/]*$/,Un=/^([^:]+:)[\s\S]*$/,qn=/^([^:]+:\/*[^/]*)[\s\S]*$/;function Hn(s,e){ke[" "+s]||(On.test(s)?ke[" "+s]=s+"/":ke[" "+s]=$e(s,"/",!0)),s=ke[" "+s];const t=s.indexOf(":")===-1;return e.substring(0,2)==="//"?t?e:s.replace(Un,"$1")+e:e.charAt(0)==="/"?t?e:s.replace(qn,"$1")+e:s+e}const De={exec:function(){}};function W(s){let e=1,t,r;for(;e<arguments.length;e++){t=arguments[e];for(r in t)Object.prototype.hasOwnProperty.call(t,r)&&(s[r]=t[r])}return s}function at(s,e){const t=s.replace(/\|/g,(i,l,a)=>{let o=!1,c=l;for(;--c>=0&&a[c]==="\\";)o=!o;return o?"|":" |"}),r=t.split(/ \|/);let n=0;if(r[0].trim()||r.shift(),r.length>0&&!r[r.length-1].trim()&&r.pop(),r.length>e)r.splice(e);else for(;r.length<e;)r.push("");for(;n<r.length;n++)r[n]=r[n].trim().replace(/\\\|/g,"|");return r}function $e(s,e,t){const r=s.length;if(r===0)return"";let n=0;for(;n<r;){const i=s.charAt(r-n-1);if(i===e&&!t)n++;else if(i!==e&&t)n++;else break}return s.slice(0,r-n)}function Fn(s,e){if(s.indexOf(e[1])===-1)return-1;const t=s.length;let r=0,n=0;for(;n<t;n++)if(s[n]==="\\")n++;else if(s[n]===e[0])r++;else if(s[n]===e[1]&&(r--,r<0))return n;return-1}function It(s){s&&s.sanitize&&!s.silent&&console.warn("marked(): sanitize and sanitizer parameters are deprecated since version 0.7.0, should not be used and will be removed in the future. Read more here: https://marked.js.org/#/USING_ADVANCED.md#options")}function ct(s,e){if(e<1)return"";let t="";for(;e>1;)e&1&&(t+=s),e>>=1,s+=s;return t+s}function ft(s,e,t,r){const n=e.href,i=e.title?q(e.title):null,l=s[1].replace(/\\([\[\]])/g,"$1");if(s[0].charAt(0)!=="!"){r.state.inLink=!0;const a={type:"link",raw:t,href:n,title:i,text:l,tokens:r.inlineTokens(l,[])};return r.state.inLink=!1,a}return{type:"image",raw:t,href:n,title:i,text:q(l)}}function Wn(s,e){const t=s.match(/^(\s+)(?:```)/);if(t===null)return e;const r=t[1];return e.split(`
`).map(n=>{const i=n.match(/^\s+/);if(i===null)return n;const[l]=i;return l.length>=r.length?n.slice(r.length):n}).join(`
`)}class Be{constructor(e){this.options=e||fe}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const r=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?r:$e(r,`
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const r=t[0],n=Wn(r,t[3]||"");return{type:"code",raw:r,lang:t[2]?t[2].trim():t[2],text:n}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let r=t[2].trim();if(/#$/.test(r)){const i=$e(r,"#");(this.options.pedantic||!i||/ $/.test(i))&&(r=i.trim())}const n={type:"heading",raw:t[0],depth:t[1].length,text:r,tokens:[]};return this.lexer.inline(n.text,n.tokens),n}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){const r=t[0].replace(/^ *>[ \t]?/gm,"");return{type:"blockquote",raw:t[0],tokens:this.lexer.blockTokens(r,[]),text:r}}}list(e){let t=this.rules.block.list.exec(e);if(t){let r,n,i,l,a,o,c,f,g,m,d,u,k=t[1].trim();const A=k.length>1,I={type:"list",raw:"",ordered:A,start:A?+k.slice(0,-1):"",loose:!1,items:[]};k=A?`\\d{1,9}\\${k.slice(-1)}`:`\\${k}`,this.options.pedantic&&(k=A?k:"[*+-]");const U=new RegExp(`^( {0,3}${k})((?:[	 ][^\\n]*)?(?:\\n|$))`);for(;e&&(u=!1,!(!(t=U.exec(e))||this.rules.block.hr.test(e)));){if(r=t[0],e=e.substring(r.length),f=t[2].split(`
`,1)[0],g=e.split(`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return this.options.xhtml?"<br/>":"<br>"}del(e){return`<del>${e}</del>`}link(e,t,r){if(e=ot(this.options.sanitize,this.options.baseUrl,e),e===null)return r;let n='<a href="'+q(e)+'"';return t&&(n+=' title="'+t+'"'),n+=">"+r+"</a>",n}image(e,t,r){if(e=ot(this.options.sanitize,this.options.baseUrl,e),e===null)return r;let n=`<img src="${e}" alt="${r}"`;return t&&(n+=` title="${t}"`),n+=this.options.xhtml?"/>":">",n}text(e){return e}}class Tt{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,r){return""+r}image(e,t,r){return""+r}br(){return""}}class Ne{constructor(){this.seen={}}serialize(e){return e.toLowerCase().trim().replace(/<[!\/a-z].*?>/ig,"").replace(/[\u2000-\u206F\u2E00-\u2E7F\\'!"#$%&()*+,./:;<=>?@[\]^`{|}~]/g,"").replace(/\s/g,"-")}getNextSafeSlug(e,t){let r=e,n=0;if(this.seen.hasOwnProperty(r)){n=this.seen[e];do n++,r=e+"-"+n;while(this.seen.hasOwnProperty(r))}return t||(this.seen[e]=n,this.seen[r]=0),r}slug(e,t={}){const r=this.serialize(e);return this.getNextSafeSlug(r,t.dryrun)}}class te{constructor(e){this.options=e||fe,this.options.renderer=this.options.renderer||new Me,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Tt,this.slugger=new Ne}static parse(e,t){return new te(t).parse(e)}static parseInline(e,t){return new te(t).parseInline(e)}parse(e,t=!0){let r="",n,i,l,a,o,c,f,g,m,d,u,k,A,I,U,Z,X,J,re;const _e=e.length;for(n=0;n<_e;n++){if(d=e[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[d.type]&&(re=this.options.extensions.renderers[d.type].call({parser:this},d),re!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(d.type))){r+=re||"";continue}switch(d.type){case"space":continue;case"hr":{r+=this.renderer.hr();continue}case"heading":{r+=this.renderer.heading(this.parseInline(d.tokens),d.depth,Dt(this.parseInline(d.tokens,this.textRenderer)),this.slugger);continue}case"code":{r+=this.renderer.code(d.text,d.lang,d.escaped);continue}case"table":{for(g="",f="",a=d.header.length,i=0;i<a;i++)f+=this.renderer.tablecell(this.parseInline(d.header[i].tokens),{header:!0,align:d.align[i]});for(g+=this.renderer.tablerow(f),m="",a=d.rows.length,i=0;i<a;i++){for(c=d.rows[i],f="",o=c.length,l=0;l<o;l++)f+=this.renderer.tablecell(this.parseInline(c[l].tokens),{header:!1,align:d.align[l]});m+=this.renderer.tablerow(f)}r+=this.renderer.table(g,m);continue}case"blockquote":{m=this.parse(d.tokens),r+=this.renderer.blockquote(m);continue}case"list":{for(u=d.ordered,k=d.start,A=d.loose,a=d.items.length,m="",i=0;i<a;i++)U=d.items[i],Z=U.checked,X=U.task,I="",U.task&&(J=this.renderer.checkbox(Z),A?U.tokens.length>0&&U.tokens[0].type==="paragraph"?(U.tokens[0].text=J+" "+U.tokens[0].text,U.tokens[0].tokens&&U.tokens[0].tokens.length>0&&U.tokens[0].tokens[0].type==="text"&&(U.tokens[0].tokens[0].text=J+" "+U.tokens[0].tokens[0].text)):U.tokens.unshift({type:"text",text:J}):I+=J),I+=this.parse(U.tokens,A),m+=this.renderer.listitem(I,X,Z);r+=this.renderer.list(m,u,k);continue}case"html":{r+=this.renderer.html(d.text);continue}case"paragraph":{r+=this.renderer.paragraph(this.parseInline(d.tokens));continue}case"text":{for(m=d.tokens?this.parseInline(d.tokens):d.text;n+1<_e&&e[n+1].type==="text";)d=e[++n],m+=`
`+(d.tokens?this.parseInline(d.tokens):d.text);r+=t?this.renderer.paragraph(m):m;continue}default:{const ue='Token with "'+d.type+'" type was not found.';if(this.options.silent){console.error(ue);return}else throw new Error(ue)}}}return r}parseInline(e,t){t=t||this.renderer;let r="",n,i,l;const a=e.length;for(n=0;n<a;n++){if(i=e[n],this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[i.type]&&(l=this.options.extensions.renderers[i.type].call({parser:this},i),l!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(i.type))){r+=l||"";continue}switch(i.type){case"escape":{r+=t.text(i.text);break}case"html":{r+=t.html(i.text);break}case"link":{r+=t.link(i.href,i.title,this.parseInline(i.tokens,t));break}case"image":{r+=t.image(i.href,i.title,i.text);break}case"strong":{r+=t.strong(this.parseInline(i.tokens,t));break}case"em":{r+=t.em(this.parseInline(i.tokens,t));break}case"codespan":{r+=t.codespan(i.text);break}case"br":{r+=t.br();break}case"del":{r+=t.del(this.parseInline(i.tokens,t));break}case"text":{r+=t.text(i.text);break}default:{const o='Token with "'+i.type+'" type was not found.';if(this.options.silent){console.error(o);return}else throw new Error(o)}}}return r}}function $(s,e,t){if(typeof s=="undefined"||s===null)throw new Error("marked(): input parameter is undefined or null");if(typeof s!="string")throw new Error("marked(): input parameter is of type "+Object.prototype.toString.call(s)+", string expected");if(typeof e=="function"&&(t=e,e=null),e=W({},$.defaults,e||{}),It(e),t){const r=e.highlight;let n;try{n=K.lex(s,e)}catch(a){return t(a)}const i=function(a){let o;if(!a)try{e.walkTokens&&$.walkTokens(n,e.walkTokens),o=te.parse(n,e)}catch(c){a=c}return e.highlight=r,a?t(a):t(null,o)};if(!r||r.length<3||(delete e.highlight,!n.length))return i();let l=0;$.walkTokens(n,function(a){a.type==="code"&&(l++,setTimeout(()=>{r(a.text,a.lang,function(o,c){if(o)return i(o);c!=null&&c!==a.text&&(a.text=c,a.escaped=!0),l--,l===0&&i()})},0))}),l===0&&i();return}try{const r=K.lex(s,e);return e.walkTokens&&$.walkTokens(r,e.walkTokens),te.parse(r,e)}catch(r){if(r.message+=`
Please report this to https://github.com/markedjs/marked.`,e.silent)return"<p>An error occurred:</p><pre>"+q(r.message+"",!0)+"</pre>";throw r}}$.options=$.setOptions=function(s){return W($.defaults,s),Rn($.defaults),$};$.getDefaults=Ct;$.defaults=fe;$.use=function(...s){const e=W({},...s),t=$.defaults.extensions||{renderers:{},childTokens:{}};let r;s.forEach(n=>{if(n.extensions&&(r=!0,n.extensions.forEach(i=>{if(!i.name)throw new Error("extension name required");if(i.renderer){const l=t.renderers?t.renderers[i.name]:null;l?t.renderers[i.name]=function(...a){let o=i.renderer.apply(this,a);return o===!1&&(o=l.apply(this,a)),o}:t.renderers[i.name]=i.renderer}if(i.tokenizer){if(!i.level||i.level!=="block"&&i.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");t[i.level]?t[i.level].unshift(i.tokenizer):t[i.level]=[i.tokenizer],i.start&&(i.level==="block"?t.startBlock?t.startBlock.push(i.start):t.startBlock=[i.start]:i.level==="inline"&&(t.startInline?t.startInline.push(i.start):t.startInline=[i.start]))}i.childTokens&&(t.childTokens[i.name]=i.childTokens)})),n.renderer){const i=$.defaults.renderer||new Me;for(const l in n.renderer){const a=i[l];i[l]=(...o)=>{let c=n.renderer[l].apply(i,o);return c===!1&&(c=a.apply(i,o)),c}}e.renderer=i}if(n.tokenizer){const i=$.defaults.tokenizer||new Be;for(const l in n.tokenizer){const a=i[l];i[l]=(...o)=>{let c=n.tokenizer[l].apply(i,o);return c===!1&&(c=a.apply(i,o)),c}}e.tokenizer=i}if(n.walkTokens){const i=$.defaults.walkTokens;e.walkTokens=function(l){n.walkTokens.call(this,l),i&&i.call(this,l)}}r&&(e.extensions=t),$.setOptions(e)})};$.walkTokens=function(s,e){for(const t of s)switch(e.call($,t),t.type){case"table":{for(const r of t.header)$.walkTokens(r.tokens,e);for(const r of t.rows)for(const n of r)$.walkTokens(n.tokens,e);break}case"list":{$.walkTokens(t.items,e);break}default:$.defaults.extensions&&$.defaults.extensions.childTokens&&$.defaults.extensions.childTokens[t.type]?$.defaults.extensions.childTokens[t.type].forEach(function(r){$.walkTokens(t[r],e)}):t.tokens&&$.walkTokens(t.tokens,e)}};$.parseInline=function(s,e){if(typeof s=="undefined"||s===null)throw new Error("marked.parseInline(): input parameter is undefined or null");if(typeof s!="string")throw new Error("marked.parseInline(): input parameter is of type "+Object.prototype.toString.call(s)+", string expected");e=W({},$.defaults,e||{}),It(e);try{const t=K.lexInline(s,e);return e.walkTokens&&$.walkTokens(t,e.walkTokens),te.parseInline(t,e)}catch(t){if(t.message+=`
Please report this to https://github.com/markedjs/marked.`,e.silent)return"<p>An error occurred:</p><pre>"+q(t.message+"",!0)+"</pre>";throw t}};$.Parser=te;$.parser=te.parse;$.Renderer=Me;$.TextRenderer=Tt;$.Lexer=K;$.lexer=K.lex;$.Tokenizer=Be;$.Slugger=Ne;$.parse=$;$.options;$.setOptions;$.use;$.walkTokens;$.parseInline;te.parse;K.lex;const Rt={};function Vn(s){let e;return{c(){e=V(s[1])},m(t,r){w(t,e,r)},p(t,r){r&2&&ie(e,t[1])},i:B,o:B,d(t){t&&_(e)}}}function Qn(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h6"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Kn(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h5"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Xn(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h4"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Jn(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h3"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Yn(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h2"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function er(s){let e,t;const r=s[5].default,n=M(r,s,s[4],null);return{c(){e=x("h1"),n&&n.c(),z(e,"id",s[2])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&16)&&L(n,r,i,i[4],t?N(r,i[4],l,null):O(i[4]),null),(!t||l&4)&&z(e,"id",i[2])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function tr(s){let e,t,r,n;const i=[er,Yn,Jn,Xn,Kn,Qn,Vn],l=[];function a(o,c){return o[0]===1?0:o[0]===2?1:o[0]===3?2:o[0]===4?3:o[0]===5?4:o[0]===6?5:6}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,[c]){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function nr(s,e,t){let r,{$$slots:n={},$$scope:i}=e,{depth:l}=e,{raw:a}=e,{text:o}=e;const{slug:c,getOptions:f}=Yt(Rt),g=f();return s.$$set=m=>{"depth"in m&&t(0,l=m.depth),"raw"in m&&t(1,a=m.raw),"text"in m&&t(3,o=m.text),"$$scope"in m&&t(4,i=m.$$scope)},s.$$.update=()=>{s.$$.dirty&8&&t(2,r=g.headerIds?g.headerPrefix+c(o):void 0)},[l,a,r,o,i,n]}class rr extends G{constructor(e){super(),P(this,e,nr,tr,E,{depth:0,raw:1,text:3})}}function ir(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("p"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function sr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class lr extends G{constructor(e){super(),P(this,e,sr,ir,E,{})}}function or(s){let e;const t=s[3].default,r=M(t,s,s[2],null);return{c(){r&&r.c()},m(n,i){r&&r.m(n,i),e=!0},p(n,[i]){r&&r.p&&(!e||i&4)&&L(r,t,n,n[2],e?N(t,n[2],i,null):O(n[2]),null)},i(n){e||(p(r,n),e=!0)},o(n){h(r,n),e=!1},d(n){r&&r.d(n)}}}function ar(s,e,t){let{$$slots:r={},$$scope:n}=e,{text:i}=e,{raw:l}=e;return s.$$set=a=>{"text"in a&&t(0,i=a.text),"raw"in a&&t(1,l=a.raw),"$$scope"in a&&t(2,n=a.$$scope)},[i,l,n,r]}class cr extends G{constructor(e){super(),P(this,e,ar,or,E,{text:0,raw:1})}}function fr(s){let e,t;return{c(){e=x("img"),je(e.src,t=s[0])||z(e,"src",t),z(e,"title",s[1]),z(e,"alt",s[2])},m(r,n){w(r,e,n)},p(r,[n]){n&1&&!je(e.src,t=r[0])&&z(e,"src",t),n&2&&z(e,"title",r[1]),n&4&&z(e,"alt",r[2])},i:B,o:B,d(r){r&&_(e)}}}function ur(s,e,t){let{href:r=""}=e,{title:n=void 0}=e,{text:i=""}=e;return s.$$set=l=>{"href"in l&&t(0,r=l.href),"title"in l&&t(1,n=l.title),"text"in l&&t(2,i=l.text)},[r,n,i]}class pr extends G{constructor(e){super(),P(this,e,ur,fr,E,{href:0,title:1,text:2})}}function dr(s){let e,t;const r=s[3].default,n=M(r,s,s[2],null);return{c(){e=x("a"),n&&n.c(),z(e,"href",s[0]),z(e,"title",s[1])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&4)&&L(n,r,i,i[2],t?N(r,i[2],l,null):O(i[2]),null),(!t||l&1)&&z(e,"href",i[0]),(!t||l&2)&&z(e,"title",i[1])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function hr(s,e,t){let{$$slots:r={},$$scope:n}=e,{href:i=""}=e,{title:l=void 0}=e;return s.$$set=a=>{"href"in a&&t(0,i=a.href),"title"in a&&t(1,l=a.title),"$$scope"in a&&t(2,n=a.$$scope)},[i,l,n,r]}class mr extends G{constructor(e){super(),P(this,e,hr,dr,E,{href:0,title:1})}}function gr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("em"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function _r(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class wr extends G{constructor(e){super(),P(this,e,_r,gr,E,{})}}function br(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("del"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function kr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class yr extends G{constructor(e){super(),P(this,e,kr,br,E,{})}}function Ar(s){let e,t=s[0].replace(/`/g,"")+"",r;return{c(){e=x("code"),r=V(t)},m(n,i){w(n,e,i),H(e,r)},p(n,[i]){i&1&&t!==(t=n[0].replace(/`/g,"")+"")&&ie(r,t)},i:B,o:B,d(n){n&&_(e)}}}function $r(s,e,t){let{raw:r}=e;return s.$$set=n=>{"raw"in n&&t(0,r=n.raw)},[r]}class zr extends G{constructor(e){super(),P(this,e,$r,Ar,E,{raw:0})}}function xr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("strong"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function vr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Cr extends G{constructor(e){super(),P(this,e,vr,xr,E,{})}}function Dr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("table"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Ir(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Tr extends G{constructor(e){super(),P(this,e,Ir,Dr,E,{})}}function Rr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("thead"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Sr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Er extends G{constructor(e){super(),P(this,e,Sr,Rr,E,{})}}function jr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("tbody"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Pr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Gr extends G{constructor(e){super(),P(this,e,Pr,jr,E,{})}}function Br(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("tr"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Mr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Nr extends G{constructor(e){super(),P(this,e,Mr,Br,E,{})}}function Lr(s){let e,t;const r=s[3].default,n=M(r,s,s[2],null);return{c(){e=x("td"),n&&n.c(),z(e,"align",s[1])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&4)&&L(n,r,i,i[2],t?N(r,i[2],l,null):O(i[2]),null),(!t||l&2)&&z(e,"align",i[1])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Or(s){let e,t;const r=s[3].default,n=M(r,s,s[2],null);return{c(){e=x("th"),n&&n.c(),z(e,"align",s[1])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&4)&&L(n,r,i,i[2],t?N(r,i[2],l,null):O(i[2]),null),(!t||l&2)&&z(e,"align",i[1])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Ur(s){let e,t,r,n;const i=[Or,Lr],l=[];function a(o,c){return o[0]?0:1}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,[c]){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function qr(s,e,t){let{$$slots:r={},$$scope:n}=e,{header:i}=e,{align:l}=e;return s.$$set=a=>{"header"in a&&t(0,i=a.header),"align"in a&&t(1,l=a.align),"$$scope"in a&&t(2,n=a.$$scope)},[i,l,n,r]}class Hr extends G{constructor(e){super(),P(this,e,qr,Ur,E,{header:0,align:1})}}function Fr(s){let e,t;const r=s[3].default,n=M(r,s,s[2],null);return{c(){e=x("ul"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&4)&&L(n,r,i,i[2],t?N(r,i[2],l,null):O(i[2]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Wr(s){let e,t;const r=s[3].default,n=M(r,s,s[2],null);return{c(){e=x("ol"),n&&n.c(),z(e,"start",s[1])},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,l){n&&n.p&&(!t||l&4)&&L(n,r,i,i[2],t?N(r,i[2],l,null):O(i[2]),null),(!t||l&2)&&z(e,"start",i[1])},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Zr(s){let e,t,r,n;const i=[Wr,Fr],l=[];function a(o,c){return o[0]?0:1}return e=a(s),t=l[e]=i[e](s),{c(){t.c(),r=j()},m(o,c){l[e].m(o,c),w(o,r,c),n=!0},p(o,[c]){let f=e;e=a(o),e===f?l[e].p(o,c):(T(),h(l[f],1,1,()=>{l[f]=null}),R(),t=l[e],t?t.p(o,c):(t=l[e]=i[e](o),t.c()),p(t,1),t.m(r.parentNode,r))},i(o){n||(p(t),n=!0)},o(o){h(t),n=!1},d(o){l[e].d(o),o&&_(r)}}}function Vr(s,e,t){let{$$slots:r={},$$scope:n}=e,{ordered:i}=e,{start:l}=e;return s.$$set=a=>{"ordered"in a&&t(0,i=a.ordered),"start"in a&&t(1,l=a.start),"$$scope"in a&&t(2,n=a.$$scope)},[i,l,n,r]}class Qr extends G{constructor(e){super(),P(this,e,Vr,Zr,E,{ordered:0,start:1})}}function Kr(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("li"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function Xr(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class Jr extends G{constructor(e){super(),P(this,e,Xr,Kr,E,{})}}function Yr(s){let e;return{c(){e=x("hr")},m(t,r){w(t,e,r)},p:B,i:B,o:B,d(t){t&&_(e)}}}class ei extends G{constructor(e){super(),P(this,e,null,Yr,E,{})}}function ti(s){let e,t;return{c(){e=new Wt(!1),t=j(),e.a=t},m(r,n){e.m(s[0],r,n),w(r,t,n)},p(r,[n]){n&1&&e.p(r[0])},i:B,o:B,d(r){r&&_(t),r&&e.d()}}}function ni(s,e,t){let{text:r}=e;return s.$$set=n=>{"text"in n&&t(0,r=n.text)},[r]}class ri extends G{constructor(e){super(),P(this,e,ni,ti,E,{text:0})}}function ii(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("blockquote"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(e,null),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function si(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class li extends G{constructor(e){super(),P(this,e,si,ii,E,{})}}function oi(s){let e,t,r;return{c(){e=x("pre"),t=x("code"),r=V(s[1]),z(e,"class",s[0])},m(n,i){w(n,e,i),H(e,t),H(t,r)},p(n,[i]){i&2&&ie(r,n[1]),i&1&&z(e,"class",n[0])},i:B,o:B,d(n){n&&_(e)}}}function ai(s,e,t){let{lang:r}=e,{text:n}=e;return s.$$set=i=>{"lang"in i&&t(0,r=i.lang),"text"in i&&t(1,n=i.text)},[r,n]}class ci extends G{constructor(e){super(),P(this,e,ai,oi,E,{lang:0,text:1})}}function fi(s){let e,t;const r=s[1].default,n=M(r,s,s[0],null);return{c(){e=x("br"),n&&n.c()},m(i,l){w(i,e,l),n&&n.m(i,l),t=!0},p(i,[l]){n&&n.p&&(!t||l&1)&&L(n,r,i,i[0],t?N(r,i[0],l,null):O(i[0]),null)},i(i){t||(p(n,i),t=!0)},o(i){h(n,i),t=!1},d(i){i&&_(e),n&&n.d(i)}}}function ui(s,e,t){let{$$slots:r={},$$scope:n}=e;return s.$$set=i=>{"$$scope"in i&&t(0,n=i.$$scope)},[n,r]}class pi extends G{constructor(e){super(),P(this,e,ui,fi,E,{})}}const di={heading:rr,paragraph:lr,text:cr,image:pr,link:mr,em:wr,strong:Cr,codespan:zr,del:yr,table:Tr,tablehead:Er,tablebody:Gr,tablerow:Nr,tablecell:Hr,list:Qr,orderedlistitem:null,unorderedlistitem:null,listitem:Jr,hr:ei,html:ri,blockquote:li,code:ci,br:pi},hi={baseUrl:null,breaks:!1,gfm:!0,headerIds:!0,headerPrefix:"",highlight:null,langPrefix:"language-",mangle:!0,pedantic:!1,renderer:null,sanitize:!1,sanitizer:null,silent:!1,smartLists:!1,smartypants:!1,tokenizer:null,xhtml:!1};function mi(s){let e,t;return e=new le({props:{tokens:s[0],renderers:s[1]}}),{c(){D(e.$$.fragment)},m(r,n){v(e,r,n),t=!0},p(r,[n]){const i={};n&1&&(i.tokens=r[0]),n&2&&(i.renderers=r[1]),e.$set(i)},i(r){t||(p(e.$$.fragment,r),t=!0)},o(r){h(e.$$.fragment,r),t=!1},d(r){C(e,r)}}}function gi(s,e,t){let r,n,i,{source:l=""}=e,{renderers:a={}}=e,{options:o={}}=e,{isInline:c=!1}=e;const f=Xt();let g,m,d;return Jt(Rt,{slug:u=>r?r.slug(u):"",getOptions:()=>n}),xt(()=>{t(7,d=!0)}),s.$$set=u=>{"source"in u&&t(2,l=u.source),"renderers"in u&&t(3,a=u.renderers),"options"in u&&t(4,o=u.options),"isInline"in u&&t(5,c=u.isInline)},s.$$.update=()=>{s.$$.dirty&4&&(r=l?new Ne:void 0),s.$$.dirty&16&&t(8,n=pe(pe({},hi),o)),s.$$.dirty&357&&(t(6,m=new K(n)),t(0,g=c?m.inlineTokens(l):m.lex(l)),f("parsed",{tokens:g})),s.$$.dirty&8&&t(1,i=pe(pe({},di),a)),s.$$.dirty&129&&d&&f("parsed",{tokens:g})},[g,i,l,a,o,c,m,d,n]}class _i extends G{constructor(e){super(),P(this,e,gi,mi,E,{source:2,renderers:3,options:4,isInline:5})}}function wi(s){return s<.5?4*s*s*s:.5*Math.pow(2*s-2,3)+1}function Ie(s,{delay:e=0,duration:t=400,easing:r=wi,amount:n=5,opacity:i=0}={}){const l=getComputedStyle(s),a=+l.opacity,o=l.filter==="none"?"":l.filter,c=a*(1-i);return{delay:e,duration:t,easing:r,css:(f,g)=>`opacity: ${a-c*g}; filter: ${o} blur(${g*n}px);`}}var bi="/revit-api/assets/logo-dh.ebfbfda1.svg";function pt(s){let e,t,r=s[1]>s[2]&&dt(s);return{c(){r&&r.c(),e=j()},m(n,i){r&&r.m(n,i),w(n,e,i),t=!0},p(n,i){n[1]>n[2]?r?(r.p(n,i),i&6&&p(r,1)):(r=dt(n),r.c(),p(r,1),r.m(e.parentNode,e)):r&&(T(),h(r,1,1,()=>{r=null}),R())},i(n){t||(p(r),t=!0)},o(n){h(r),t=!1},d(n){r&&r.d(n),n&&_(e)}}}function dt(s){let e,t,r,n;return{c(){e=x("p"),t=V(s[0]),z(e,"class","title svelte-lw7png")},m(i,l){w(i,e,l),H(e,t),n=!0},p(i,l){(!n||l&1)&&ie(t,i[0])},i(i){n||(Q(()=>{r||(r=Ce(e,Ie,{},!0)),r.run(1)}),n=!0)},o(i){r||(r=Ce(e,Ie,{},!1)),r.run(0),n=!1},d(i){i&&_(e),i&&r&&r.end()}}}function ht(s){let e,t,r=s[1]>s[2]&&mt();return{c(){r&&r.c(),e=j()},m(n,i){r&&r.m(n,i),w(n,e,i),t=!0},p(n,i){n[1]>n[2]?r?i&6&&p(r,1):(r=mt(),r.c(),p(r,1),r.m(e.parentNode,e)):r&&(T(),h(r,1,1,()=>{r=null}),R())},i(n){t||(p(r),t=!0)},o(n){h(r),t=!1},d(n){r&&r.d(n),n&&_(e)}}}function mt(s){let e,t,r;return{c(){e=x("footer"),e.textContent="Dawid Huczy\u0144ski",z(e,"class","svelte-lw7png")},m(n,i){w(n,e,i),r=!0},i(n){r||(Q(()=>{t||(t=Ce(e,Ie,{},!0)),t.run(1)}),r=!0)},o(n){t||(t=Ce(e,Ie,{},!1)),t.run(0),r=!1},d(n){n&&_(e),n&&t&&t.end()}}}function ki(s){let e=!1,t=()=>{e=!1},r,n,i,l,a,o,c,f,g,m;Q(s[3]),Q(s[4]);let d=s[0]&&pt(s),u=s[0]&&ht(s);return{c(){n=x("div"),i=x("img"),a=F(),d&&d.c(),o=F(),u&&u.c(),c=j(),z(i,"class","logo svelte-lw7png"),z(i,"alt",""),je(i.src,l=bi)||z(i,"src",l),z(n,"class","baner svelte-lw7png")},m(k,A){w(k,n,A),H(n,i),H(n,a),d&&d.m(n,null),w(k,o,A),u&&u.m(k,A),w(k,c,A),f=!0,g||(m=[ze(window,"scroll",()=>{e=!0,clearTimeout(r),r=setTimeout(t,100),s[3]()}),ze(window,"resize",s[4])],g=!0)},p(k,[A]){A&2&&!e&&(e=!0,clearTimeout(r),scrollTo(window.pageXOffset,k[1]),r=setTimeout(t,100)),k[0]?d?(d.p(k,A),A&1&&p(d,1)):(d=pt(k),d.c(),p(d,1),d.m(n,null)):d&&(T(),h(d,1,1,()=>{d=null}),R()),k[0]?u?(u.p(k,A),A&1&&p(u,1)):(u=ht(k),u.c(),p(u,1),u.m(c.parentNode,c)):u&&(T(),h(u,1,1,()=>{u=null}),R())},i(k){f||(p(d),p(u),f=!0)},o(k){h(d),h(u),f=!1},d(k){k&&_(n),d&&d.d(),k&&_(o),u&&u.d(k),k&&_(c),g=!1,ne(m)}}}function yi(s,e,t){let{title:r}=e,n,i;function l(){t(1,n=window.pageYOffset)}function a(){t(2,i=window.innerHeight)}return s.$$set=o=>{"title"in o&&t(0,r=o.title)},[r,n,i,l,a]}class Ai extends G{constructor(e){super(),P(this,e,yi,ki,E,{title:0})}}function $i(s){let e=!1,t=()=>{e=!1},r,n,i,l,a,o,c,f,g,m;return Q(s[5]),Q(s[6]),{c(){n=x("div"),i=x("div"),l=F(),a=x("p"),o=V(s[3]),c=V("/"),f=V(s[0]),z(i,"class","progress svelte-16znpub"),He(i,"width",s[4]+"%"),z(n,"class","bar svelte-16znpub"),z(a,"class","nrstrony svelte-16znpub")},m(d,u){w(d,n,u),H(n,i),w(d,l,u),w(d,a,u),H(a,o),H(a,c),H(a,f),g||(m=[ze(window,"scroll",()=>{e=!0,clearTimeout(r),r=setTimeout(t,100),s[5]()}),ze(window,"resize",s[6])],g=!0)},p(d,[u]){u&2&&!e&&(e=!0,clearTimeout(r),scrollTo(window.pageXOffset,d[1]),r=setTimeout(t,100)),u&16&&He(i,"width",d[4]+"%"),u&8&&ie(o,d[3]),u&1&&ie(f,d[0])},i:B,o:B,d(d){d&&_(n),d&&_(l),d&&_(a),g=!1,ne(m)}}}function zi(s,e,t){let r,{iloscSlajdow:n=1}=e,i,l,a=1;function o(){t(1,i=window.pageYOffset)}function c(){t(2,l=window.innerHeight)}return s.$$set=f=>{"iloscSlajdow"in f&&t(0,n=f.iloscSlajdow)},s.$$.update=()=>{s.$$.dirty&7&&t(4,r=i/(l*(n-1))*100),s.$$.dirty&6&&t(3,a=Math.floor(i/l)+1)},[n,i,l,a,r,o,c]}class xi extends G{constructor(e){super(),P(this,e,zi,$i,E,{iloscSlajdow:0})}}function vi(s){let e;return{c(){e=x("nav"),e.innerHTML=`<a href="#2" class="svelte-8rp04l">Spotkanie 1</a> 
    ...
    <a href="#37" class="svelte-8rp04l">Program 5</a>`,z(e,"class","svelte-8rp04l")},m(t,r){w(t,e,r)},p:B,i:B,o:B,d(t){t&&_(e)}}}class Ci extends G{constructor(e){super(),P(this,e,null,vi,E,{})}}let Di=`
...
`;function gt(s,e,t){const r=s.slice();return r[3]=e[t],r}function _t(s){let e,t,r,n,i,l;r=new _i({props:{source:s[3]}});function a(...o){return s[1](s[3],...o)}return{c(){e=x("section"),t=x("div"),D(r.$$.fragment),n=F(),z(e,"id",i=(s[0].findIndex(a)+1).toString()),z(e,"class","svelte-op1al2")},m(o,c){w(o,e,c),H(e,t),v(r,t,null),H(e,n),l=!0},p(o,c){s=o},i(o){l||(p(r.$$.fragment,o),l=!0)},o(o){h(r.$$.fragment,o),l=!1},d(o){o&&_(e),C(r)}}}function Ii(s){let e,t,r,n,i,l,a,o,c,f;document.title=e=Ee,r=new Ai({props:{title:Ee}}),i=new Ci({});let g=s[0],m=[];for(let u=0;u<g.length;u+=1)m[u]=_t(gt(s,g,u));const d=u=>h(m[u],1,1,()=>{m[u]=null});return c=new xi({props:{iloscSlajdow:s[0].length}}),{c(){t=F(),D(r.$$.fragment),n=F(),D(i.$$.fragment),l=F(),a=x("main");for(let u=0;u<m.length;u+=1)m[u].c();o=F(),D(c.$$.fragment)},m(u,k){w(u,t,k),v(r,u,k),w(u,n,k),v(i,u,k),w(u,l,k),w(u,a,k);for(let A=0;A<m.length;A+=1)m[A].m(a,null);w(u,o,k),v(c,u,k),f=!0},p(u,[k]){if((!f||k&0)&&e!==(e=Ee)&&(document.title=e),k&1){g=u[0];let A;for(A=0;A<g.length;A+=1){const I=gt(u,g,A);m[A]?(m[A].p(I,k),p(m[A],1)):(m[A]=_t(I),m[A].c(),p(m[A],1),m[A].m(a,null))}for(T(),A=g.length;A<m.length;A+=1)d(A);R()}},i(u){if(!f){p(r.$$.fragment,u),p(i.$$.fragment,u);for(let k=0;k<g.length;k+=1)p(m[k]);p(c.$$.fragment,u),f=!0}},o(u){h(r.$$.fragment,u),h(i.$$.fragment,u),m=m.filter(Boolean);for(let k=0;k<m.length;k+=1)h(m[k]);h(c.$$.fragment,u),f=!1},d(u){u&&_(t),C(r,u),u&&_(n),C(i,u),u&&_(l),u&&_(a),se(m,u),u&&_(o),C(c,u)}}}let Ee="Revit API";function Ti(s){let e=Di.split("---"),t=[];return e.forEach(n=>{let i=n.trim();t.push(i)}),[t,(n,i)=>i==n]}class Ri extends G{constructor(e){super(),P(this,e,Ti,Ii,E,{})}}new Ri({target:document.getElementById("app")});
