...
?])[ 	]*(?:<<prop>>[ 	]+)?)<<key>>(?=\\s*:\\s)`.replace(/<<prop>>/g,function(){return e}).replace(/<<key>>/g,function(){return"(?:"+o+"|"+s+")"})),lookbehind:!0,greedy:!0,alias:"atrule"},directive:{pattern:/(^[ \t]*)%.+/m,lookbehind:!0,alias:"important"},datetime:{pattern:a("\\d{4}-\\d\\d?-\\d\\d?(?:[tT]|[ 	]+)\\d\\d?:\\d{2}:\\d{2}(?:\\.\\d*)?(?:[ 	]*(?:Z|[-+]\\d\\d?(?::\\d{2})?))?|\\d{4}-\\d{2}-\\d{2}|\\d\\d?:\\d{2}(?::\\d{2}(?:\\.\\d*)?)?"),lookbehind:!0,alias:"number"},boolean:{pattern:a("false|true","i"),lookbehind:!0,alias:"important"},null:{pattern:a("null|~","i"),lookbehind:!0,alias:"important"},string:{pattern:a(s),lookbehind:!0,greedy:!0},number:{pattern:a("[+-]?(?:0x[\\da-f]+|0o[0-7]+|(?:\\d+(?:\\.\\d*)?|\\.\\d+)(?:e[+-]?\\d+)?|\\.inf|\\.nan)","i"),lookbehind:!0},tag:p,important:n,punctuation:/---|[:[\]{}\-,|>?]|\.\.\./},c.languages.yml=c.languages.yaml})(T);(function(){if(typeof T!="undefined"&&typeof document!="undefined"){var c="line-numbers",n=/\n(?!$)/g,p=T.plugins.lineNumbers={getLine:function(s,a){if(s.tagName==="PRE"&&s.classList.contains(c)){var l=s.querySelector(".line-numbers-rows");if(l){var m=parseInt(s.getAttribute("data-start"),10)||1,j=m+(l.children.length-1);a<m&&(a=m),a>j&&(a=j);var D=a-m;return l.children[D]}}},resize:function(s){o([s])},assumeViewportIndependence:!0},e=void 0;window.addEventListener("resize",function(){p.assumeViewportIndependence&&e===window.innerWidth||(e=window.innerWidth,o(Array.prototype.slice.call(document.querySelectorAll("pre.line-numbers"))))}),T.hooks.add("complete",function(s){if(s.code){var a=s.element,l=a.parentNode;if(l&&/pre/i.test(l.nodeName)&&!a.querySelector(".line-numbers-rows")&&T.util.isActive(a,c)){a.classList.remove(c),l.classList.add(c);var m,j=s.code.match(n),D=j?j.length+1:1,x=new Array(D+1).join("<span></span>");(m=document.createElement("span")).setAttribute("aria-hidden","true"),m.className="line-numbers-rows",m.innerHTML=x,l.hasAttribute("data-start")&&(l.style.counterReset="linenumber "+(parseInt(l.getAttribute("data-start"),10)-1)),s.element.appendChild(m),o([l]),T.hooks.run("line-numbers",s)}}}),T.hooks.add("line-numbers",function(s){s.plugins=s.plugins||{},s.plugins.lineNumbers=!0})}function o(s){if((s=s.filter(function(l){var m,j=(m=l,m?window.getComputedStyle?getComputedStyle(m):m.currentStyle||null:null)["white-space"];return j==="pre-wrap"||j==="pre-line"})).length!=0){var a=s.map(function(l){var m=l.querySelector("code"),j=l.querySelector(".line-numbers-rows");if(m&&j){var D=l.querySelector(".line-numbers-sizer"),x=m.textContent.split(n);D||((D=document.createElement("span")).className="line-numbers-sizer",m.appendChild(D)),D.innerHTML="0",D.style.display="block";var N=D.getBoundingClientRect().height;return D.innerHTML="",{element:l,lines:x,lineHeights:[],oneLinerHeight:N,sizer:D}}}).filter(Boolean);a.forEach(function(l){var m=l.sizer,j=l.lines,D=l.lineHeights,x=l.oneLinerHeight;D[j.length-1]=void 0,j.forEach(function(N,H){if(N&&N.length>1){var $=m.appendChild(document.createElement("span"));$.style.display="block",$.textContent=N}else D[H]=x})}),a.forEach(function(l){for(var m=l.sizer,j=l.lineHeights,D=0,x=0;x<j.length;x++)j[x]===void 0&&(j[x]=m.children[D++].getBoundingClientRect().height)}),a.forEach(function(l){var m=l.sizer,j=l.element.querySelector(".line-numbers-rows");m.style.display="none",m.innerHTML="",l.lineHeights.forEach(function(D,x){j.children[x].style.height=D+"px"})})}}})();function St(c){let n;return{c(){n=k("nav"),n.innerHTML=`<a href="#spotkanie-1" class="svelte-f6k7du">Spotkanie 1</a> 
    ...
    <a href="#program-6" class="svelte-f6k7du">Aktualizuj osie</a>`,R(n,"class","svelte-f6k7du")},m(p,e){u(p,n,e)},p:z,i:z,o:z,d(p){p&&i(n)}}}class zt extends as{constructor(n){super(),ts(this,n,null,St,es,{})}}function Tt(c){let n,p,e;const o=c[2].default,s=ot(o,c,c[1],null);return{c(){n=k("section"),p=k("div"),s&&s.c(),R(p,"class","center svelte-i9wwgh"),R(n,"id",c[0]),R(n,"class","line-numbers svelte-i9wwgh")},m(a,l){u(a,n,l),Us(n,p),s&&s.m(p,null),e=!0},p(a,[l]){s&&s.p&&(!e||l&2)&&ct(s,o,a,a[1],e?lt(o,a[1],l,null):it(a[1]),null),(!e||l&1)&&R(n,"id",a[0])},i(a){e||(g(s,a),e=!0)},o(a){y(s,a),e=!1},d(a){a&&i(n),s&&s.d(a)}}}function At(c,n,p){let{$$slots:e={},$$scope:o}=n,{id:s}=n;return c.$$set=a=>{"id"in a&&p(0,s=a.id),"$$scope"in a&&p(1,o=a.$$scope)},[s,o,e]}class A extends as{constructor(n){super(),ts(this,n,At,Tt,es,{id:0})}}const Et=c=>({}),et=c=>({class:"code svelte-qgcnhp"});function It(c){let n,p,e,o;const s=c[1].default,a=ot(s,c,c[0],et);return{c(){n=k("div"),p=k("div"),p.innerHTML=`<div class="button red svelte-qgcnhp"></div> 
        <div class="button yellow svelte-qgcnhp"></div> 
        <div class="button green svelte-qgcnhp"></div>`,e=f(),a&&a.c(),R(p,"class","menu svelte-qgcnhp"),R(n,"class","codeblock line-numbers svelte-qgcnhp")},m(l,m){u(l,n,m),Us(n,p),Us(n,e),a&&a.m(n,null),o=!0},p(l,[m]){a&&a.p&&(!o||m&1)&&ct(a,s,l,l[0],o?lt(s,l[0],m,Et):it(l[0]),et)},i(l){o||(g(a,l),o=!0)},o(l){y(a,l),o=!1},d(l){l&&i(n),a&&a.d(l)}}}function Ct(c,n,p){let{$$slots:e={},$$scope:o}=n;return c.$$set=s=>{"$$scope"in s&&p(0,o=s.$$scope)},[o,e]}class M extends as{constructor(n){super(),ts(this,n,Ct,It,es,{})}}function Rt(c){let n,p,e,o,s;return{c(){n=k("h1"),n.textContent="Wprowadzenie do API Revita",p=f(),e=k("h2"),e.innerHTML='<a href="https://dawid.huczynski.pl/revit-api" rel="nofollow">dawid.huczynski.pl/revit-api</a>',o=f(),s=k("h3"),s.innerHTML='<a href="dawid.huczynski@gmail.com">dawid.huczynski@gmail.com</a>'},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function xt(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 1."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Dt(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Narz\u0119dzia i ustawianie \u015Brodowiska",p=f(),e=k("ul"),e.innerHTML=`<li><strong>Pyrevit</strong> - addon do tworzenia w\u0142asnych dodatk\xF3w oraz ma\u0142y kombajn z narz\u0119dziami: <br/> 
...
<a href="https://git-scm.com/" rel="nofollow">https://git-scm.com/</a></li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function Pt(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Miejsca do szukania wiedzy:",p=f(),e=k("ul"),e.innerHTML=`<li><a href="https://www.revitapidocs.com/" rel="nofollow">https://www.revitapidocs.com/</a></li> 
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Lt(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[Mt]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Spos\xF3b czytania skrypt\xF3w",p=f(),e=k("ul"),e.innerHTML=`<li><code>#! python3</code> - definiuje jakiego j\u0119zyka u\u017Cywa skrypt</li> 
<li><code># -*- coding: utf-8 -*-</code> - definuje zakres znak\xF3w unicode UTF-8 (tu te\u017C s\u0105 polskie znaki)</li>`,o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function Ft(c){let n,p=`<code class="language-sh">pip install --user pipenv
pipenv install requests
pipenv run python main.py
pipenv shell

</code>`;return{c(){n=k("pre"),R(n,"class","language-sh")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Gt(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ft]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="pipenv",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Ot(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> sys
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Nt(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ot]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="U\u017Cywanie bibliotek pythona",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Ht(c){let n,p,e;return{c(){n=k("h2"),n.textContent="API a wersje pythona",p=f(),e=k("ul"),e.innerHTML=`<li>API Dynamo - zale\u017Cnie od wersji Dynamo IronPython 2.7 / python 3.8</li> 
<li>API RPSHELL (Python) - IronPython 2.7 / python 3.8</li> 
<li>API Macros - IronPython 2.7</li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function Bt(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="J\u0119zyk statyczny i dynamiczny",p=f(),e=k("p"),e.textContent="Types - typy (int, float, str, Object, Enum, Element, Id):",o=f(),s=k("ul"),s.innerHTML=`<li>static types</li> 
<li>dynamic types</li>`},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function Ut(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr <span class="token comment"># .NET's Common Language Runtime.</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Wt(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[Ut]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Podstawy API",p=f(),e=k("p"),e.innerHTML=`Kod do skopiowania do skrypt\xF3w Dynamo. NIE KOPIUJCIE TEGO, serio! :D<br/>
s\u0142owo klucz: \u201CMaintnance\u201D`,o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function qt(c){let n,p=`<code class="language-python"><span class="token keyword">def</span> <span class="token function">feet_to_meter</span><span class="token punctuation">(</span>feet<span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Vt(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[qt]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Co ma skarpetka wsp\xF3lnego z Revitem?",p=f(),e=k("p"),e.textContent="jednostki",o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function Zt(c){let n,p=`<code class="language-python">detail_line <span class="token operator">=</span> UnwrapElement<span class="token punctuation">(</span>IN<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span><span class="token punctuation">)</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Kt(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Zt]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Inny spos\xF3b na jednostki",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Xt(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> os
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Yt(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Xt]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Struktura API i przeszukiwanie",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Jt(c){let n,p,e,o,s;return{c(){n=k("h3"),n.innerHTML='<a href="./revit-struktura.html">Autodesk.Revit</a>',p=f(),e=k("p"),e.textContent="U\u017Cyteczne komendy do przegl\u0105dania:",o=f(),s=k("ul"),s.innerHTML=`<li>dir <code>for x in dir(element):print(x)</code></li> 
<li>help(element)</li>`},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function Qt(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Podstawowe klasy",p=f(),e=k("h2"),e.textContent="Element.*",o=f(),s=k("div"),s.innerHTML=`<p>ArePhasesModifiable<br/>
...
WorksetId<br/>
getBoundingBox<br/>
setElementType<br/></p>`,R(s,"class","trzy-kolumny")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function na(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Podstawowe klasy",p=f(),e=k("h2"),e.textContent="Wall.*",o=f(),s=k("div"),s.innerHTML=`<p>ArePhasesModifiable<br/>
AssemblyInstanceId<br/> 
<strong>BoundingBox</strong><br/>
CanBeHidden<br/>
CanBeLocked<br/>
...
WorksetId<br/>
getBoundingBox<br/>
setElementType<br/></p>`,R(s,"class","trzy-kolumny")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function sa(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("ul"),e.innerHTML=`<li>mo\u017Cliwo\u015Bci</li> 
<li>tworzenie interfejsu do skryptu</li> 
<li>ustawianie addin\xF3w pod firm\u0119 (pipeline developera)</li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function ea(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-tab.png" alt="pyrevit-tab"/>',o=f(),s=k("ol"),s.innerHTML=`<li>Tab coloring - koloruje wam zak\u0142adki wg otwartych projekt\xF3w i rodzin. Minify revit UI - chowa wam g\xF3rne zak\u0142adki kt\xF3rych nie u\u017Cywacie np mi zostawia tylko Architecture, Annotate i Modify ( ustawia si\u0119 to klikaj\u0105c na ikonk\u0119 s SHIFTEM)</li> 
...
<li>Czyszczenie rzeczy kt\xF3re czasami jest zbyt dobre, ale przynajmniej potrafi wyczy\u015Bci\u0107 elementy kt\xF3rych nie czy\u015Bci purge.</li>`},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function ta(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-sheets.png" alt="pyrevit-sheets"/>',o=f(),s=k("ol"),s.innerHTML="<li>Sheets - dla mnie najwygodniejsze jest kopiowanie legend na inne rysunki (PB, PW - na jednym rysunku ustawiasz powtarzaj\u0105ce si\u0119 legendy a potem kopiujesz je na wszystkie inne rysunki i wklejaj\u0105 si\u0119 w tym samym miejscu) Druga to Batch Sheet Maker - na szybko generuje du\u017Co rysunk\xF3w wpisujesz tylko nr rysunku [tab] nazewa rysunku i masz rysunek ( ja do PW mam w pliku tekstowym zestaw rysunk\xF3w kt\xF3re przeklejam do tego narz\u0119dzia na etapie PW i od razu mam przygotowane puste rysunki z numerami i nazwami.</li>",R(s,"start","5")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function aa(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-views.png" alt="pyrevit-views"/>',o=f(),s=k("ol"),s.innerHTML="<li>Duzo u\u0142atwien w tym miejscu, najfajniejsze to chyba Kopiowanie view templates do innych otwartych plik\xF3w.</li>",R(s,"start","6")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function oa(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-checks1.png" alt="pyrevit-checks1"/>',o=f(),s=k("ol"),s.innerHTML="<li>Preflight Checks - moje ulubione narz\u0119dzie pokazuje w \u0142adnej graficznej formie \u201Ckondycj\u0119\u201D twojego revitowego pliku i co mo\u017Ce by\u0107 do poprawy.</li>",R(s,"start","7")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function pa(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-checks2.png" alt="pyrevit-checks2"/>',o=f(),s=k("ol"),s.innerHTML="<li>Preflight Checks - moje ulubione narz\u0119dzie pokazuje w \u0142adnej graficznej formie \u201Ckondycj\u0119\u201D twojego revitowego pliku i co mo\u017Ce by\u0107 do poprawy.</li>",R(s,"start","7")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function la(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-checks3.png" alt="pyrevit-checks3"/>',o=f(),s=k("ol"),s.innerHTML="<li>Preflight Checks - moje ulubione narz\u0119dzie pokazuje w \u0142adnej graficznej formie \u201Ckondycj\u0119\u201D twojego revitowego pliku i co mo\u017Ce by\u0107 do poprawy.</li>",R(s,"start","7")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function ca(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-checks4.png" alt="pyrevit-checks4"/>',o=f(),s=k("ol"),s.innerHTML="<li>Preflight Checks - moje ulubione narz\u0119dzie pokazuje w \u0142adnej graficznej formie \u201Ckondycj\u0119\u201D twojego revitowego pliku i co mo\u017Ce by\u0107 do poprawy.</li>",R(s,"start","7")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function ia(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Pyrevit",p=f(),e=k("p"),e.innerHTML='<img src="./pyrevit-who.png" alt="pyrevit-who"/>',o=f(),s=k("ol"),s.innerHTML="<li>Team - wa\u017Cna rzecz do sprawdzania: Who did that? kto stworzy\u0142 elementi kto ostatni go edytowa\u0142.</li>",R(s,"start","8")},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function ua(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 2."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function ra(c){let n,p=`<code class="language-python"><span class="token keyword">class</span> <span class="token class-name">Osoba</span><span class="token punctuation">(</span><span class="token punctuation">)</span><span class="token punctuation">:</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function ka(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[ra]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Klasy",p=f(),e=k("p"),e.textContent="Czym s\u0105 klasy i ich dziedziczenie",o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function fa(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Pomocne biblioteki Pythona",p=f(),e=k("ul"),e.innerHTML=`<li>math</li> 
<li>itertools</li> 
...
<li>bokeh / plotly</li> 
<li>pillow</li> 
<li>k3d</li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function ma(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function da(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[ma]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Dynamo",p=f(),e=k("ul"),e.innerHTML=`<li>UnwrapElement</li> 
<li>Transaction a TransactionGroup a TransactionManager</li> 
<li>uidoc.Selection</li> 
<li>pr\xF3ba wyja\u015Bnienia r\xF3\u017Cnic (importowane biblioteki).</li>`,o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function $a(c){let n,p=`<code class="language-python">input_list_of_numbers <span class="token operator">=</span> IN<span class="token punctuation">[</span><span class="token number">0</span><span class="token punctuation">]</span> <span class="token comment">#Here we take an input</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function ga(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[$a]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Dynamo IN-OUT",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function ya(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Revit Python Shell",p=f(),e=k("p"),e.textContent="Interaktywna zabawa"},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function wa(c){let n,p=`<code class="language-python">collector <span class="token operator">=</span> FilteredElementCollector<span class="token punctuation">(</span>doc<span class="token punctuation">)</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function _a(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[wa]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="FilteredElementCollector",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function ba(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function va(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[ba]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="uidoc.Selection",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function ha(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function ja(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[ha]},$$scope:{ctx:c}}}),{c(){n=k("h3"),n.textContent="Filtrowanie + zaznaczanie",p=f(),e=k("p"),e.textContent="Skrypt do wybierania element\xF3w i zanzaczania ich w modelu",o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function Sa(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 3."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function za(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Transaction",p=f(),e=k("p"),e.textContent="Jak dzia\u0142a wprowadzanie zmian w modelu. S\u0105 trzy typy transakcji:",o=f(),s=k("ul"),s.innerHTML=`<li>Transaction</li> 
<li>TransactionGroup</li> 
<li>TransactionManager - Dynamo</li>`},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function Ta(c){let n,p=`<code class="language-python">TransactionManager<span class="token punctuation">.</span>Instance<span class="token punctuation">.</span>EnsureInTransaction<span class="token punctuation">(</span>doc<span class="token punctuation">)</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Aa(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ta]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="TransactionManager - Dynamo",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Ea(c){let n,p=`<code class="language-python">t <span class="token operator">=</span> Transaction<span class="token punctuation">(</span>doc<span class="token punctuation">,</span> <span class="token string">'Opis'</span><span class="token punctuation">)</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Ia(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ea]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Transaction",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Ca(c){let n,p=`<code class="language-python">tg <span class="token operator">=</span> TransactionGroup<span class="token punctuation">(</span>doc<span class="token punctuation">,</span> <span class="token string">"&#123;&#125; number assing"</span><span class="token punctuation">.</span><span class="token builtin">format</span><span class="token punctuation">(</span>el_type<span class="token punctuation">)</span><span class="token punctuation">)</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Ra(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ca]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="TransactionGroup",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function xa(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Da(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[xa]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Parametry",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Pa(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Rodzaje parametr\xF3w",p=f(),e=k("ul"),e.innerHTML=`<li>String [str] <code>Nazwa Budynku</code></li> 
<li>Double [float] <code>3.14</code></li> 
<li>Integer [int]  <code>2345</code></li> 
<li>Element - inny obiekt Revitowy (Level)</li> 
<li>BuiltInParameter</li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function Ma(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
<span class="token comment">#   Category</span>
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function La(c){let n,p,e,o,s,a;return s=new M({props:{$$slots:{default:[Ma]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="ParameterMap",p=f(),e=k("p"),e.textContent="Jak wyci\u0105gn\u0105\u0107 informacje o parametrach",o=f(),b(s.$$.fragment)},m(l,m){u(l,n,m),u(l,p,m),u(l,e,m),u(l,o,m),w(s,l,m),a=!0},p(l,m){const j={};m&1&&(j.$$scope={dirty:m,ctx:l}),s.$set(j)},i(l){a||(g(s.$$.fragment,l),a=!0)},o(l){y(s.$$.fragment,l),a=!1},d(l){l&&i(n),l&&i(p),l&&i(e),l&&i(o),_(s,l)}}}function Fa(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 4."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Ga(c){let n,p,e;return{c(){n=k("h2"),n.textContent="W\u0142asna zak\u0142adka w Revicie",p=f(),e=k("p"),e.innerHTML='<img src="./dh-tab.jpg" alt="dh-tab"/>'},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function Oa(c){let n,p,e,o,s;return{c(){n=k("h2"),n.textContent="Przyk\u0142ad od wi\u0119kszego kolegi z bran\u017Cy",p=f(),e=k("p"),e.innerHTML='<a href="https://youtu.be/5Pup98apob4" rel="nofollow">Webinar BIG</a>',o=f(),s=k("p"),s.innerHTML='<img src="./BIG-ribbon.jpg" alt="BIG-ribbon"/>'},m(a,l){u(a,n,l),u(a,p,l),u(a,e,l),u(a,o,l),u(a,s,l)},p:z,d(a){a&&i(n),a&&i(p),a&&i(e),a&&i(o),a&&i(s)}}}function Na(c){let n,p,e,o;return{c(){n=k("h2"),n.textContent="Struktura folder\xF3w:",p=f(),e=k("img"),dt(e.src,o="folder.svg")||R(e,"src",o),R(e,"alt","")},m(s,a){u(s,n,a),u(s,p,a),u(s,e,a)},p:z,d(s){s&&i(n),s&&i(p),s&&i(e)}}}function Ha(c){let n;return{c(){n=k("h2"),n.textContent="Szybkie uruchamianie"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Ba(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 5."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Ua(c){let n,p,e;return{c(){n=k("h2"),n.textContent="Views",p=f(),e=k("ul"),e.innerHTML=`<li>View</li> 
<li>FloorView</li> 
<li>Viewport</li>`},m(o,s){u(o,n,s),u(o,p,s),u(o,e,s)},p:z,d(o){o&&i(n),o&&i(p),o&&i(e)}}}function Wa(c){let n;return{c(){n=k("h2"),n.textContent="ViewTemplates"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function qa(c){let n;return{c(){n=k("h2"),n.textContent="Linked documents"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Va(c){let n;return{c(){n=k("h1"),n.textContent="Spotkanie 6."},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Za(c){let n;return{c(){n=k("h2"),n.textContent="Wymiarowanie"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Ka(c){let n;return{c(){n=k("h1"),n.textContent="Praca wsp\xF3lna:"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function Xa(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Ya(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Xa]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Narysuj \u015Bcian\u0119",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function Ja(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function Qa(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[Ja]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Modyfikuj parametry \u015Bciany",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function no(c){let n,p=`<code class="language-python"><span class="token keyword">import</span> clr
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function so(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[no]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Zbierz dane ze \u015Bcian",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function eo(c){let n,p=`<code class="language-python"><span class="token keyword">from</span> Autodesk<span class="token punctuation">.</span>Revit<span class="token punctuation">.</span>DB <span class="token keyword">import</span> <span class="token punctuation">(</span>
    FilteredElementCollector<span class="token punctuation">,</span>
...
</code>`;return{c(){n=k("pre"),R(n,"class","language-python")},m(e,o){u(e,n,o),n.innerHTML=p},p:z,d(e){e&&i(n)}}}function to(c){let n,p,e,o;return e=new M({props:{$$slots:{default:[eo]},$$scope:{ctx:c}}}),{c(){n=k("h2"),n.textContent="Wstaw rodzin\u0119",p=f(),b(e.$$.fragment)},m(s,a){u(s,n,a),u(s,p,a),w(e,s,a),o=!0},p(s,a){const l={};a&1&&(l.$$scope={dirty:a,ctx:s}),e.$set(l)},i(s){o||(g(e.$$.fragment,s),o=!0)},o(s){y(e.$$.fragment,s),o=!1},d(s){s&&i(n),s&&i(p),_(e,s)}}}function ao(c){let n;return{c(){n=k("h2"),n.textContent="Aktualizuj osie"},m(p,e){u(p,n,e)},p:z,d(p){p&&i(n)}}}function oo(c){let n,p,e,o,s,a,l,m,j,D,x,N,H,$,d,h,v,S,E,I,C,L,P,Q,V,Un,Y,Wn,Z,F,G,K,O,nn,U,qn,B,J,W,sn,X,en,q,tn,an,os,on,ps,pn,ls,ln,cs,cn,is,un,us,rn,rs,kn,ks,fn,fs,mn,ms,dn,ds,$n,$s,gn,gs,yn,ys,wn,ws,_n,_s,bn,bs,vn,vs,hn,hs,jn,js,Sn,Ss,zn,zs,Tn,Ts,An,As,En,Es,In,Is,Cn,Cs,Rn,Rs,xn,xs,Dn,Ds,Pn,Ps,Mn,Ms,Ln,Ls,Fn,Fs,Gn,Gs,On,Os,Nn,Ns,Hn,Hs,Bn,Vn;return document.title=n=tt,e=new zt({}),s=new A({props:{$$slots:{default:[Rt]},$$scope:{ctx:c}}}),l=new A({props:{id:"spotkanie-1",$$slots:{default:[xt]},$$scope:{ctx:c}}}),j=new A({props:{$$slots:{default:[Dt]},$$scope:{ctx:c}}}),x=new A({props:{$$slots:{default:[Pt]},$$scope:{ctx:c}}}),H=new A({props:{$$slots:{default:[Lt]},$$scope:{ctx:c}}}),d=new A({props:{$$slots:{default:[Gt]},$$scope:{ctx:c}}}),v=new A({props:{$$slots:{default:[Nt]},$$scope:{ctx:c}}}),E=new A({props:{$$slots:{default:[Ht]},$$scope:{ctx:c}}}),C=new A({props:{$$slots:{default:[Bt]},$$scope:{ctx:c}}}),P=new A({props:{$$slots:{default:[Wt]},$$scope:{ctx:c}}}),V=new A({props:{$$slots:{default:[Vt]},$$scope:{ctx:c}}}),Y=new A({props:{$$slots:{default:[Kt]},$$scope:{ctx:c}}}),Z=new A({props:{$$slots:{default:[Yt]},$$scope:{ctx:c}}}),G=new A({props:{$$slots:{default:[Jt]},$$scope:{ctx:c}}}),O=new A({props:{$$slots:{default:[Qt]},$$scope:{ctx:c}}}),U=new A({props:{$$slots:{default:[na]},$$scope:{ctx:c}}}),B=new A({props:{$$slots:{default:[sa]},$$scope:{ctx:c}}}),W=new A({props:{$$slots:{default:[ea]},$$scope:{ctx:c}}}),X=new A({props:{$$slots:{default:[ta]},$$scope:{ctx:c}}}),q=new A({props:{$$slots:{default:[aa]},$$scope:{ctx:c}}}),an=new A({props:{$$slots:{default:[oa]},$$scope:{ctx:c}}}),on=new A({props:{$$slots:{default:[pa]},$$scope:{ctx:c}}}),pn=new A({props:{$$slots:{default:[la]},$$scope:{ctx:c}}}),ln=new A({props:{$$slots:{default:[ca]},$$scope:{ctx:c}}}),cn=new A({props:{$$slots:{default:[ia]},$$scope:{ctx:c}}}),un=new A({props:{id:"spotkanie-2",$$slots:{default:[ua]},$$scope:{ctx:c}}}),rn=new A({props:{$$slots:{default:[ka]},$$scope:{ctx:c}}}),kn=new A({props:{$$slots:{default:[fa]},$$scope:{ctx:c}}}),fn=new A({props:{$$slots:{default:[da]},$$scope:{ctx:c}}}),mn=new A({props:{$$slots:{default:[ga]},$$scope:{ctx:c}}}),dn=new A({props:{$$slots:{default:[ya]},$$scope:{ctx:c}}}),$n=new A({props:{$$slots:{default:[_a]},$$scope:{ctx:c}}}),gn=new A({props:{$$slots:{default:[va]},$$scope:{ctx:c}}}),yn=new A({props:{$$slots:{default:[ja]},$$scope:{ctx:c}}}),wn=new A({props:{id:"spotkanie-3",$$slots:{default:[Sa]},$$scope:{ctx:c}}}),_n=new A({props:{$$slots:{default:[za]},$$scope:{ctx:c}}}),bn=new A({props:{$$slots:{default:[Aa]},$$scope:{ctx:c}}}),vn=new A({props:{$$slots:{default:[Ia]},$$scope:{ctx:c}}}),hn=new A({props:{$$slots:{default:[Ra]},$$scope:{ctx:c}}}),jn=new A({props:{$$slots:{default:[Da]},$$scope:{ctx:c}}}),Sn=new A({props:{$$slots:{default:[Pa]},$$scope:{ctx:c}}}),zn=new A({props:{$$slots:{default:[La]},$$scope:{ctx:c}}}),Tn=new A({props:{id:"spotkanie-4",$$slots:{default:[Fa]},$$scope:{ctx:c}}}),An=new A({props:{$$slots:{default:[Ga]},$$scope:{ctx:c}}}),En=new A({props:{$$slots:{default:[Oa]},$$scope:{ctx:c}}}),In=new A({props:{$$slots:{default:[Na]},$$scope:{ctx:c}}}),Cn=new A({props:{$$slots:{default:[Ha]},$$scope:{ctx:c}}}),Rn=new A({props:{id:"spotkanie-5",$$slots:{default:[Ba]},$$scope:{ctx:c}}}),xn=new A({props:{$$slots:{default:[Ua]},$$scope:{ctx:c}}}),Dn=new A({props:{$$slots:{default:[Wa]},$$scope:{ctx:c}}}),Pn=new A({props:{$$slots:{default:[qa]},$$scope:{ctx:c}}}),Mn=new A({props:{id:"spotkanie-6",$$slots:{default:[Va]},$$scope:{ctx:c}}}),Ln=new A({props:{$$slots:{default:[Za]},$$scope:{ctx:c}}}),Fn=new A({props:{$$slots:{default:[Ka]},$$scope:{ctx:c}}}),Gn=new A({props:{id:"program-1",$$slots:{default:[Ya]},$$scope:{ctx:c}}}),On=new A({props:{id:"program-2",$$slots:{default:[Qa]},$$scope:{ctx:c}}}),Nn=new A({props:{id:"program-3",$$slots:{default:[so]},$$scope:{ctx:c}}}),Hn=new A({props:{id:"program-4",$$slots:{default:[to]},$$scope:{ctx:c}}}),Bn=new A({props:{id:"program-6",$$slots:{default:[ao]},$$scope:{ctx:c}}}),{c(){p=f(),b(e.$$.fragment),o=f(),b(s.$$.fragment),a=f(),b(l.$$.fragment),m=f(),b(j.$$.fragment),D=f(),b(x.$$.fragment),N=f(),b(H.$$.fragment),$=f(),b(d.$$.fragment),h=f(),b(v.$$.fragment),S=f(),b(E.$$.fragment),I=f(),b(C.$$.fragment),L=f(),b(P.$$.fragment),Q=f(),b(V.$$.fragment),Un=f(),b(Y.$$.fragment),Wn=f(),b(Z.$$.fragment),F=f(),b(G.$$.fragment),K=f(),b(O.$$.fragment),nn=f(),b(U.$$.fragment),qn=f(),b(B.$$.fragment),J=f(),b(W.$$.fragment),sn=f(),b(X.$$.fragment),en=f(),b(q.$$.fragment),tn=f(),b(an.$$.fragment),os=f(),b(on.$$.fragment),ps=f(),b(pn.$$.fragment),ls=f(),b(ln.$$.fragment),cs=f(),b(cn.$$.fragment),is=f(),b(un.$$.fragment),us=f(),b(rn.$$.fragment),rs=f(),b(kn.$$.fragment),ks=f(),b(fn.$$.fragment),fs=f(),b(mn.$$.fragment),ms=f(),b(dn.$$.fragment),ds=f(),b($n.$$.fragment),$s=f(),b(gn.$$.fragment),gs=f(),b(yn.$$.fragment),ys=f(),b(wn.$$.fragment),ws=f(),b(_n.$$.fragment),_s=f(),b(bn.$$.fragment),bs=f(),b(vn.$$.fragment),vs=f(),b(hn.$$.fragment),hs=f(),b(jn.$$.fragment),js=f(),b(Sn.$$.fragment),Ss=f(),b(zn.$$.fragment),zs=f(),b(Tn.$$.fragment),Ts=f(),b(An.$$.fragment),As=f(),b(En.$$.fragment),Es=f(),b(In.$$.fragment),Is=f(),b(Cn.$$.fragment),Cs=f(),b(Rn.$$.fragment),Rs=f(),b(xn.$$.fragment),xs=f(),b(Dn.$$.fragment),Ds=f(),b(Pn.$$.fragment),Ps=f(),b(Mn.$$.fragment),Ms=f(),b(Ln.$$.fragment),Ls=f(),b(Fn.$$.fragment),Fs=f(),b(Gn.$$.fragment),Gs=f(),b(On.$$.fragment),Os=f(),b(Nn.$$.fragment),Ns=f(),b(Hn.$$.fragment),Hs=f(),b(Bn.$$.fragment)},m(t,r){u(t,p,r),w(e,t,r),u(t,o,r),w(s,t,r),u(t,a,r),w(l,t,r),u(t,m,r),w(j,t,r),u(t,D,r),w(x,t,r),u(t,N,r),w(H,t,r),u(t,$,r),w(d,t,r),u(t,h,r),w(v,t,r),u(t,S,r),w(E,t,r),u(t,I,r),w(C,t,r),u(t,L,r),w(P,t,r),u(t,Q,r),w(V,t,r),u(t,Un,r),w(Y,t,r),u(t,Wn,r),w(Z,t,r),u(t,F,r),w(G,t,r),u(t,K,r),w(O,t,r),u(t,nn,r),w(U,t,r),u(t,qn,r),w(B,t,r),u(t,J,r),w(W,t,r),u(t,sn,r),w(X,t,r),u(t,en,r),w(q,t,r),u(t,tn,r),w(an,t,r),u(t,os,r),w(on,t,r),u(t,ps,r),w(pn,t,r),u(t,ls,r),w(ln,t,r),u(t,cs,r),w(cn,t,r),u(t,is,r),w(un,t,r),u(t,us,r),w(rn,t,r),u(t,rs,r),w(kn,t,r),u(t,ks,r),w(fn,t,r),u(t,fs,r),w(mn,t,r),u(t,ms,r),w(dn,t,r),u(t,ds,r),w($n,t,r),u(t,$s,r),w(gn,t,r),u(t,gs,r),w(yn,t,r),u(t,ys,r),w(wn,t,r),u(t,ws,r),w(_n,t,r),u(t,_s,r),w(bn,t,r),u(t,bs,r),w(vn,t,r),u(t,vs,r),w(hn,t,r),u(t,hs,r),w(jn,t,r),u(t,js,r),w(Sn,t,r),u(t,Ss,r),w(zn,t,r),u(t,zs,r),w(Tn,t,r),u(t,Ts,r),w(An,t,r),u(t,As,r),w(En,t,r),u(t,Es,r),w(In,t,r),u(t,Is,r),w(Cn,t,r),u(t,Cs,r),w(Rn,t,r),u(t,Rs,r),w(xn,t,r),u(t,xs,r),w(Dn,t,r),u(t,Ds,r),w(Pn,t,r),u(t,Ps,r),w(Mn,t,r),u(t,Ms,r),w(Ln,t,r),u(t,Ls,r),w(Fn,t,r),u(t,Fs,r),w(Gn,t,r),u(t,Gs,r),w(On,t,r),u(t,Os,r),w(Nn,t,r),u(t,Ns,r),w(Hn,t,r),u(t,Hs,r),w(Bn,t,r),Vn=!0},p(t,[r]){(!Vn||r&0)&&n!==(n=tt)&&(document.title=n);const Zs={};r&1&&(Zs.$$scope={dirty:r,ctx:t}),s.$set(Zs);const Ks={};r&1&&(Ks.$$scope={dirty:r,ctx:t}),l.$set(Ks);const Xs={};r&1&&(Xs.$$scope={dirty:r,ctx:t}),j.$set(Xs);const Ys={};r&1&&(Ys.$$scope={dirty:r,ctx:t}),x.$set(Ys);const Js={};r&1&&(Js.$$scope={dirty:r,ctx:t}),H.$set(Js);const Qs={};r&1&&(Qs.$$scope={dirty:r,ctx:t}),d.$set(Qs);const ne={};r&1&&(ne.$$scope={dirty:r,ctx:t}),v.$set(ne);const se={};r&1&&(se.$$scope={dirty:r,ctx:t}),E.$set(se);const ee={};r&1&&(ee.$$scope={dirty:r,ctx:t}),C.$set(ee);const te={};r&1&&(te.$$scope={dirty:r,ctx:t}),P.$set(te);const ae={};r&1&&(ae.$$scope={dirty:r,ctx:t}),V.$set(ae);const oe={};r&1&&(oe.$$scope={dirty:r,ctx:t}),Y.$set(oe);const pe={};r&1&&(pe.$$scope={dirty:r,ctx:t}),Z.$set(pe);const le={};r&1&&(le.$$scope={dirty:r,ctx:t}),G.$set(le);const ce={};r&1&&(ce.$$scope={dirty:r,ctx:t}),O.$set(ce);const ie={};r&1&&(ie.$$scope={dirty:r,ctx:t}),U.$set(ie);const ue={};r&1&&(ue.$$scope={dirty:r,ctx:t}),B.$set(ue);const re={};r&1&&(re.$$scope={dirty:r,ctx:t}),W.$set(re);const ke={};r&1&&(ke.$$scope={dirty:r,ctx:t}),X.$set(ke);const fe={};r&1&&(fe.$$scope={dirty:r,ctx:t}),q.$set(fe);const me={};r&1&&(me.$$scope={dirty:r,ctx:t}),an.$set(me);const de={};r&1&&(de.$$scope={dirty:r,ctx:t}),on.$set(de);const $e={};r&1&&($e.$$scope={dirty:r,ctx:t}),pn.$set($e);const ge={};r&1&&(ge.$$scope={dirty:r,ctx:t}),ln.$set(ge);const ye={};r&1&&(ye.$$scope={dirty:r,ctx:t}),cn.$set(ye);const we={};r&1&&(we.$$scope={dirty:r,ctx:t}),un.$set(we);const _e={};r&1&&(_e.$$scope={dirty:r,ctx:t}),rn.$set(_e);const be={};r&1&&(be.$$scope={dirty:r,ctx:t}),kn.$set(be);const ve={};r&1&&(ve.$$scope={dirty:r,ctx:t}),fn.$set(ve);const he={};r&1&&(he.$$scope={dirty:r,ctx:t}),mn.$set(he);const je={};r&1&&(je.$$scope={dirty:r,ctx:t}),dn.$set(je);const Se={};r&1&&(Se.$$scope={dirty:r,ctx:t}),$n.$set(Se);const ze={};r&1&&(ze.$$scope={dirty:r,ctx:t}),gn.$set(ze);const Te={};r&1&&(Te.$$scope={dirty:r,ctx:t}),yn.$set(Te);const Ae={};r&1&&(Ae.$$scope={dirty:r,ctx:t}),wn.$set(Ae);const Ee={};r&1&&(Ee.$$scope={dirty:r,ctx:t}),_n.$set(Ee);const Ie={};r&1&&(Ie.$$scope={dirty:r,ctx:t}),bn.$set(Ie);const Ce={};r&1&&(Ce.$$scope={dirty:r,ctx:t}),vn.$set(Ce);const Re={};r&1&&(Re.$$scope={dirty:r,ctx:t}),hn.$set(Re);const xe={};r&1&&(xe.$$scope={dirty:r,ctx:t}),jn.$set(xe);const De={};r&1&&(De.$$scope={dirty:r,ctx:t}),Sn.$set(De);const Pe={};r&1&&(Pe.$$scope={dirty:r,ctx:t}),zn.$set(Pe);const Me={};r&1&&(Me.$$scope={dirty:r,ctx:t}),Tn.$set(Me);const Le={};r&1&&(Le.$$scope={dirty:r,ctx:t}),An.$set(Le);const Fe={};r&1&&(Fe.$$scope={dirty:r,ctx:t}),En.$set(Fe);const Ge={};r&1&&(Ge.$$scope={dirty:r,ctx:t}),In.$set(Ge);const Oe={};r&1&&(Oe.$$scope={dirty:r,ctx:t}),Cn.$set(Oe);const Ne={};r&1&&(Ne.$$scope={dirty:r,ctx:t}),Rn.$set(Ne);const He={};r&1&&(He.$$scope={dirty:r,ctx:t}),xn.$set(He);const Be={};r&1&&(Be.$$scope={dirty:r,ctx:t}),Dn.$set(Be);const Ue={};r&1&&(Ue.$$scope={dirty:r,ctx:t}),Pn.$set(Ue);const We={};r&1&&(We.$$scope={dirty:r,ctx:t}),Mn.$set(We);const qe={};r&1&&(qe.$$scope={dirty:r,ctx:t}),Ln.$set(qe);const Ve={};r&1&&(Ve.$$scope={dirty:r,ctx:t}),Fn.$set(Ve);const Ze={};r&1&&(Ze.$$scope={dirty:r,ctx:t}),Gn.$set(Ze);const Ke={};r&1&&(Ke.$$scope={dirty:r,ctx:t}),On.$set(Ke);const Xe={};r&1&&(Xe.$$scope={dirty:r,ctx:t}),Nn.$set(Xe);const Ye={};r&1&&(Ye.$$scope={dirty:r,ctx:t}),Hn.$set(Ye);const Je={};r&1&&(Je.$$scope={dirty:r,ctx:t}),Bn.$set(Je)},i(t){Vn||(g(e.$$.fragment,t),g(s.$$.fragment,t),g(l.$$.fragment,t),g(j.$$.fragment,t),g(x.$$.fragment,t),g(H.$$.fragment,t),g(d.$$.fragment,t),g(v.$$.fragment,t),g(E.$$.fragment,t),g(C.$$.fragment,t),g(P.$$.fragment,t),g(V.$$.fragment,t),g(Y.$$.fragment,t),g(Z.$$.fragment,t),g(G.$$.fragment,t),g(O.$$.fragment,t),g(U.$$.fragment,t),g(B.$$.fragment,t),g(W.$$.fragment,t),g(X.$$.fragment,t),g(q.$$.fragment,t),g(an.$$.fragment,t),g(on.$$.fragment,t),g(pn.$$.fragment,t),g(ln.$$.fragment,t),g(cn.$$.fragment,t),g(un.$$.fragment,t),g(rn.$$.fragment,t),g(kn.$$.fragment,t),g(fn.$$.fragment,t),g(mn.$$.fragment,t),g(dn.$$.fragment,t),g($n.$$.fragment,t),g(gn.$$.fragment,t),g(yn.$$.fragment,t),g(wn.$$.fragment,t),g(_n.$$.fragment,t),g(bn.$$.fragment,t),g(vn.$$.fragment,t),g(hn.$$.fragment,t),g(jn.$$.fragment,t),g(Sn.$$.fragment,t),g(zn.$$.fragment,t),g(Tn.$$.fragment,t),g(An.$$.fragment,t),g(En.$$.fragment,t),g(In.$$.fragment,t),g(Cn.$$.fragment,t),g(Rn.$$.fragment,t),g(xn.$$.fragment,t),g(Dn.$$.fragment,t),g(Pn.$$.fragment,t),g(Mn.$$.fragment,t),g(Ln.$$.fragment,t),g(Fn.$$.fragment,t),g(Gn.$$.fragment,t),g(On.$$.fragment,t),g(Nn.$$.fragment,t),g(Hn.$$.fragment,t),g(Bn.$$.fragment,t),Vn=!0)},o(t){y(e.$$.fragment,t),y(s.$$.fragment,t),y(l.$$.fragment,t),y(j.$$.fragment,t),y(x.$$.fragment,t),y(H.$$.fragment,t),y(d.$$.fragment,t),y(v.$$.fragment,t),y(E.$$.fragment,t),y(C.$$.fragment,t),y(P.$$.fragment,t),y(V.$$.fragment,t),y(Y.$$.fragment,t),y(Z.$$.fragment,t),y(G.$$.fragment,t),y(O.$$.fragment,t),y(U.$$.fragment,t),y(B.$$.fragment,t),y(W.$$.fragment,t),y(X.$$.fragment,t),y(q.$$.fragment,t),y(an.$$.fragment,t),y(on.$$.fragment,t),y(pn.$$.fragment,t),y(ln.$$.fragment,t),y(cn.$$.fragment,t),y(un.$$.fragment,t),y(rn.$$.fragment,t),y(kn.$$.fragment,t),y(fn.$$.fragment,t),y(mn.$$.fragment,t),y(dn.$$.fragment,t),y($n.$$.fragment,t),y(gn.$$.fragment,t),y(yn.$$.fragment,t),y(wn.$$.fragment,t),y(_n.$$.fragment,t),y(bn.$$.fragment,t),y(vn.$$.fragment,t),y(hn.$$.fragment,t),y(jn.$$.fragment,t),y(Sn.$$.fragment,t),y(zn.$$.fragment,t),y(Tn.$$.fragment,t),y(An.$$.fragment,t),y(En.$$.fragment,t),y(In.$$.fragment,t),y(Cn.$$.fragment,t),y(Rn.$$.fragment,t),y(xn.$$.fragment,t),y(Dn.$$.fragment,t),y(Pn.$$.fragment,t),y(Mn.$$.fragment,t),y(Ln.$$.fragment,t),y(Fn.$$.fragment,t),y(Gn.$$.fragment,t),y(On.$$.fragment,t),y(Nn.$$.fragment,t),y(Hn.$$.fragment,t),y(Bn.$$.fragment,t),Vn=!1},d(t){t&&i(p),_(e,t),t&&i(o),_(s,t),t&&i(a),_(l,t),t&&i(m),_(j,t),t&&i(D),_(x,t),t&&i(N),_(H,t),t&&i($),_(d,t),t&&i(h),_(v,t),t&&i(S),_(E,t),t&&i(I),_(C,t),t&&i(L),_(P,t),t&&i(Q),_(V,t),t&&i(Un),_(Y,t),t&&i(Wn),_(Z,t),t&&i(F),_(G,t),t&&i(K),_(O,t),t&&i(nn),_(U,t),t&&i(qn),_(B,t),t&&i(J),_(W,t),t&&i(sn),_(X,t),t&&i(en),_(q,t),t&&i(tn),_(an,t),t&&i(os),_(on,t),t&&i(ps),_(pn,t),t&&i(ls),_(ln,t),t&&i(cs),_(cn,t),t&&i(is),_(un,t),t&&i(us),_(rn,t),t&&i(rs),_(kn,t),t&&i(ks),_(fn,t),t&&i(fs),_(mn,t),t&&i(ms),_(dn,t),t&&i(ds),_($n,t),t&&i($s),_(gn,t),t&&i(gs),_(yn,t),t&&i(ys),_(wn,t),t&&i(ws),_(_n,t),t&&i(_s),_(bn,t),t&&i(bs),_(vn,t),t&&i(vs),_(hn,t),t&&i(hs),_(jn,t),t&&i(js),_(Sn,t),t&&i(Ss),_(zn,t),t&&i(zs),_(Tn,t),t&&i(Ts),_(An,t),t&&i(As),_(En,t),t&&i(Es),_(In,t),t&&i(Is),_(Cn,t),t&&i(Cs),_(Rn,t),t&&i(Rs),_(xn,t),t&&i(xs),_(Dn,t),t&&i(Ds),_(Pn,t),t&&i(Ps),_(Mn,t),t&&i(Ms),_(Ln,t),t&&i(Ls),_(Fn,t),t&&i(Fs),_(Gn,t),t&&i(Gs),_(On,t),t&&i(Os),_(Nn,t),t&&i(Ns),_(Hn,t),t&&i(Hs),_(Bn,t)}}}let tt="Revit API";class po extends as{constructor(n){super(),ts(this,n,null,oo,es,{})}}new po({target:document.getElementById("app")})});export default lo();
